...
UAoEModule4_C__pf2556257598::UAoEModule4_C__pf2556257598(const FObjectInitializer& ObjectInitializer) : Super()
{
...
void UAoEModule4_C__pf2556257598::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UAoEModule4_C__pf2556257598::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void UAoEModule4_C__pf2556257598::bpf__ExecuteUbergraph_AoEModule4__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	return; // KCST_GotoReturn
}
void UAoEModule4_C__pf2556257598::bpf__ReceiveActorBeginOverlap_1__pf(AActor* bpp__OtherActor__pf)
{
	b2l__K2Node_Event_OtherActor__pf = bpp__OtherActor__pf;
	bpf__ExecuteUbergraph_AoEModule4__pf_0(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void UAoEModule4_C__pf2556257598::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UAoEModule4_C__pf2556257598::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UAoEModule4_C__pf2556257598
{
	FRegisterHelper__UAoEModule4_C__pf2556257598()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/OnCollections/Modules/AoEModule4"), &UAoEModule4_C__pf2556257598::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UAoEModule4_C__pf2556257598 Instance;
};
FRegisterHelper__UAoEModule4_C__pf2556257598 FRegisterHelper__UAoEModule4_C__pf2556257598::Instance;
