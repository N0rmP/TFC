...
UVulnerableEffect_C__pf117736272::UVulnerableEffect_C__pf117736272(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__Vulnerability__pf = 0.000000f;
	bpv__MaxStack__pf = 999;
	bCanEverAffectNavigation = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void UVulnerableEffect_C__pf117736272::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UVulnerableEffect_C__pf117736272::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void UVulnerableEffect_C__pf117736272::bpf__On_Added__pf()
{
	Super::bpf__On_Added__pf();
}
void UVulnerableEffect_C__pf117736272::bpf__On_Stacked__pf()
{
	Super::bpf__On_Stacked__pf();
}
void UVulnerableEffect_C__pf117736272::bpf__On_Die__pf()
{
	...
	do
	{
		...
		case 1:
			{
				bpfv__CallFunc_LessEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::LessEqual_IntInt(bpv__Stack__pf, 1);
		...
		case 3:
			{
				...
				{
					bpv__Owner__pf->bpf__Remove_Effect__pf(this);
				}
				__CurrentState = -1;
				break;
			}
		case 4:
			{
				bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf = UKismetMathLibrary::Subtract_IntInt(bpv__Stack__pf, 1);
				bpv__Stack__pf = bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf;
			}
		case 5:
			{
...
PRAGMA_DISABLE_OPTIMIZATION
void UVulnerableEffect_C__pf117736272::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UVulnerableEffect_C__pf117736272::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{109, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/blueprints/OnCollections/Effects/Effect.Effect_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UVulnerableEffect_C__pf117736272
{
	FRegisterHelper__UVulnerableEffect_C__pf117736272()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/OnCollections/Effects/Vulnerable-Effects/VulnerableEffect"), &UVulnerableEffect_C__pf117736272::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UVulnerableEffect_C__pf117736272 Instance;
};
FRegisterHelper__UVulnerableEffect_C__pf117736272 FRegisterHelper__UVulnerableEffect_C__pf117736272::Instance;
