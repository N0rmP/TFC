...
Uwdg_stageInfo_C__pf3053510930::Uwdg_stageInfo_C__pf3053510930(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__Button_undo__pf = nullptr;
	bpv__info_bg__pf = nullptr;
	bpv__info_img__pf = nullptr;
	bpv__info_text__pf = nullptr;
	bpv__open_stage__pf = nullptr;
	bpv__Stage_name__pf = nullptr;
...
void Uwdg_stageInfo_C__pf3053510930::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void Uwdg_stageInfo_C__pf3053510930::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__2.ComponentPropertyName = FName(TEXT("open_stage"));
	__Local__2.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__2.FunctionNameToBind = FName(TEXT("BndEvt__wdg_stageInfo_open_stage_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature"));
	...
	__Local__3.FunctionNameToBind = FName(TEXT("BndEvt__Button_undo_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	auto __Local__7 = NewObject<UImage>(__Local__1, TEXT("info_bg"), (EObjectFlags)0x00280008);
	__Local__7->ColorAndOpacity = FLinearColor(0.000000, 0.336948, 0.505208, 0.864000);
	__Local__7->Slot = __Local__6;
	__Local__6->Content = __Local__7;
	__Local__5.Add(__Local__6);
	auto __Local__8 = NewObject<UCanvasPanelSlot>(__Local__4, TEXT("CanvasPanelSlot_15"), (EObjectFlags)0x00280008);
	__Local__8->LayoutData.Offsets.Left = -314.000000f;
	__Local__8->LayoutData.Offsets.Top = -264.000000f;
	__Local__8->LayoutData.Offsets.Right = 358.666687f;
	__Local__8->LayoutData.Offsets.Bottom = 95.333328f;
	...
	auto __Local__9 = NewObject<UTextBlock>(__Local__1, TEXT("Stage_name"), (EObjectFlags)0x00280008);
	__Local__9->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[E42124464DF3166E93DFE5A43F8C320F]\", \"22DB7E2C4C2479678CAFC3AC663B23A6\", \"STAGE 1\")")	);
	auto& __Local__10 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__9->ColorAndOpacity), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__10 = FLinearColor(0.000000, 0.000000, 0.000000, 1.000000);
	__Local__9->Font.Size = 70;
	__Local__9->Slot = __Local__8;
	__Local__9->bIsVariable = true;
	__Local__8->Content = __Local__9;
	__Local__5.Add(__Local__8);
	auto __Local__11 = NewObject<UCanvasPanelSlot>(__Local__4, TEXT("CanvasPanelSlot_14"), (EObjectFlags)0x00280008);
	__Local__11->LayoutData.Offsets.Left = -310.000000f;
	__Local__11->LayoutData.Offsets.Top = -100.000000f;
	__Local__11->LayoutData.Offsets.Right = 240.333328f;
	__Local__11->LayoutData.Offsets.Bottom = 239.666672f;
	...
	auto __Local__12 = NewObject<UImage>(__Local__1, TEXT("info_img"), (EObjectFlags)0x00280008);
	__Local__12->Slot = __Local__11;
	__Local__11->Content = __Local__12;
	__Local__5.Add(__Local__11);
	auto __Local__13 = NewObject<UCanvasPanelSlot>(__Local__4, TEXT("CanvasPanelSlot_16"), (EObjectFlags)0x00280008);
	__Local__13->LayoutData.Offsets.Left = 282.000000f;
	__Local__13->LayoutData.Offsets.Top = -276.000000f;
	__Local__13->LayoutData.Offsets.Right = 50.000000f;
	...
	auto __Local__14 = NewObject<UButton>(__Local__1, TEXT("Button_undo"), (EObjectFlags)0x00280008);
	__Local__14->Slot = __Local__13;
	__Local__13->Content = __Local__14;
	__Local__5.Add(__Local__13);
	auto __Local__15 = NewObject<UCanvasPanelSlot>(__Local__4, TEXT("CanvasPanelSlot_6"), (EObjectFlags)0x00280008);
	__Local__15->LayoutData.Offsets.Left = -44.000000f;
	__Local__15->LayoutData.Offsets.Top = -96.000000f;
	__Local__15->LayoutData.Offsets.Right = 361.000000f;
	__Local__15->LayoutData.Offsets.Bottom = 236.000000f;
	__Local__15->LayoutData.Anchors.Minimum = FVector2D(0.500000, 0.500000);
	__Local__15->LayoutData.Anchors.Maximum = FVector2D(0.500000, 0.500000);
	__Local__15->Parent = __Local__4;
	auto __Local__16 = NewObject<UMultiLineEditableTextBox>(__Local__1, TEXT("info_text"), (EObjectFlags)0x00280008);
	__Local__16->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[E42124464DF3166E93DFE5A43F8C320F]\", \"66018478490268B996ED3DB7B55A7FF8\", \"Temp stage for test\")")	);
	__Local__16->WidgetStyle.Font.Size = 20;
	__Local__16->TextStyle.Font.Size = 20;
	__Local__16->Slot = __Local__15;
	__Local__15->Content = __Local__16;
	__Local__5.Add(__Local__15);
	auto __Local__17 = NewObject<UCanvasPanelSlot>(__Local__4, TEXT("CanvasPanelSlot_12"), (EObjectFlags)0x00280008);
	__Local__17->LayoutData.Offsets.Left = 114.000000f;
	__Local__17->LayoutData.Offsets.Top = 176.000000f;
	__Local__17->LayoutData.Offsets.Right = 200.000000f;
	__Local__17->LayoutData.Offsets.Bottom = 80.000000f;
	...
	auto __Local__18 = NewObject<UButton>(__Local__1, TEXT("open_stage"), (EObjectFlags)0x00280008);
	...
	auto __Local__21 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_383"), (EObjectFlags)0x00280008);
	__Local__21->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[E42124464DF3166E93DFE5A43F8C320F]\", \"6C0E718F4C63D59945FEE8BC56C2631D\", \"Start\")")	);
...
PRAGMA_ENABLE_OPTIMIZATION
void Uwdg_stageInfo_C__pf3053510930::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__23;
	SlotNames.Append(__Local__23);
}
void Uwdg_stageInfo_C__pf3053510930::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__24;
	TArray<FDelegateRuntimeBinding>  __Local__25;
	__Local__25.AddUninitialized(1);
	FDelegateRuntimeBinding::StaticStruct()->InitializeStruct(__Local__25.GetData(), 1);
	auto& __Local__26 = __Local__25[0];
	__Local__26.ObjectName = FString(TEXT("Stage_name"));
	...
	__Local__28.Name = FName(TEXT("stagename"));
	__Local__26.Kind = EBindingKind::Property;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(Uwdg_stageInfo_C__pf3053510930::StaticClass())->MiscConvertedSubobjects[0]), __Local__24, __Local__25);
}
void Uwdg_stageInfo_C__pf3053510930::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void Uwdg_stageInfo_C__pf3053510930::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__Uwdg_stageInfo_C__pf3053510930
{
	FRegisterHelper__Uwdg_stageInfo_C__pf3053510930()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/UI/wdg_stageInfo"), &Uwdg_stageInfo_C__pf3053510930::__StaticDependenciesAssets);
	}
	static FRegisterHelper__Uwdg_stageInfo_C__pf3053510930 Instance;
};
FRegisterHelper__Uwdg_stageInfo_C__pf3053510930 FRegisterHelper__Uwdg_stageInfo_C__pf3053510930::Instance;
