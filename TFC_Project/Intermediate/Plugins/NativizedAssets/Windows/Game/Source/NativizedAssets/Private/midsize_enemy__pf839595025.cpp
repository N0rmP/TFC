...
Amidsize_enemy_C__pf839595025::Amidsize_enemy_C__pf839595025(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	if(__Local__2)
	{
		...
		__Local__2->AnimClass = UThirdPerson_AnimBP_armguard_C__pf4051366165::StaticClass();
		__Local__2->AnimationData.AnimToPlay = CastChecked<UAnimationAsset>(CastChecked<UDynamicClass>(Amidsize_enemy_C__pf839595025::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
		__Local__2->SkeletalMesh = CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(Amidsize_enemy_C__pf839595025::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
		...
		__Local__2->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(Amidsize_enemy_C__pf839595025::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
		...
		auto& __Local__10 = (*(AccessPrivateProperty<FVector >((__Local__2), USceneComponent::__PPO__RelativeScale3D() )));
		__Local__10 = FVector(1.500000, 1.500000, 1.500000);
	...
	bpv__hardPoint__pf = TArray<FName> ();
	bpv__hardPoint__pf.Reserve(4);
	bpv__hardPoint__pf.Add(FName(TEXT("lowerarm_r")));
	bpv__hardPoint__pf.Add(FName(TEXT("upperarm_r")));
	bpv__hardPoint__pf.Add(FName(TEXT("lowerarm_l")));
	bpv__hardPoint__pf.Add(FName(TEXT("upperarm_l")));
	bpv__weakPoint__pf = TArray<FName> ();
	bpv__weakPoint__pf.Reserve(2);
	bpv__weakPoint__pf.Add(FName(TEXT("thigh_l")));
	bpv__weakPoint__pf.Add(FName(TEXT("thigh_r")));
	auto& __Local__13 = (*(AccessPrivateProperty<USkeletalMeshComponent*>((this), ACharacter::__PPO__Mesh() )));
	__Local__13 = __Local__2;
	auto& __Local__14 = (*(AccessPrivateProperty<UCharacterMovementComponent*>((this), ACharacter::__PPO__CharacterMovement() )));
	__Local__14 = __Local__1;
	auto& __Local__15 = (*(AccessPrivateProperty<UCapsuleComponent*>((this), ACharacter::__PPO__CapsuleComponent() )));
...
void Amidsize_enemy_C__pf839595025::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void Amidsize_enemy_C__pf839595025::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UThirdPerson_AnimBP_armguard_C__pf4051366165::StaticClass());
	...
	(((FBoolProperty*)__Local__18)->SetPropertyValue_InContainer((__Local__17), false, 0));
}
PRAGMA_ENABLE_OPTIMIZATION
void Amidsize_enemy_C__pf839595025::bpf__ExecuteUbergraph_midsize_enemy__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	bpv__state__pf = 1;
	bpv__curxWeakPointHP__pfT = 30;
	// optimized KCST_UnconditionalGoto
	bpv__Electricity_Drop__pf = 165;
	return; //KCST_EndOfThread
}
void Amidsize_enemy_C__pf839595025::bpf__ExecuteUbergraph_midsize_enemy__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 8:
			{
				bpf__get_Target__pf(bpv__state__pf);
			}
		case 9:
			{
				bpf__enemy_attack__pf(50, 100.000000, /*out*/ b2l__CallFunc_enemy_attack_hit__pf);
			}
		case 10:
			{
		...
		case 11:
			{
				UKismetSystemLibrary::Delay(this, 1.000000, FLatentActionInfo(2, -2124339486, TEXT("ExecuteUbergraph_midsize_enemy_1"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void Amidsize_enemy_C__pf839595025::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_midsize_enemy__pf_0(12);
}
void Amidsize_enemy_C__pf839595025::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b2l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_midsize_enemy__pf_1(4);
}
void Amidsize_enemy_C__pf839595025::bpf__WeakPointBreak__pf()
{
	Super::bpf__WeakPointBreak__pf();
	bpv__cndition__pf = false;
}
void Amidsize_enemy_C__pf839595025::bpf__take_damage__pf(int32 bpp__val__pf, AActor* bpp__attacker__pf, FName bpp__hit_bone_name__pf)
{
	...
	do
	{
		...
		case 4:
			{
				...
				bpfv__CallFunc_Array_Length_ReturnValue__pf = FCustomThunkTemplates::Array_Length(bpv__hardPoint__pf);
		...
		case 7:
			{
				FCustomThunkTemplates::Array_Get(bpv__hardPoint__pf, bpfv_____int_Array_Index_Variable__pf, /*out*/ bpfv__CallFunc_Array_Get_Item__pf);
		...
		case 8:
			{
				bpfv__CallFunc_Divide_IntInt_ReturnValue__pf = UKismetMathLibrary::Divide_IntInt(bpp__val__pf, 2);
				Super::bpf__take_damage__pf(bpfv__CallFunc_Divide_IntInt_ReturnValue__pf, ((AActor*)nullptr), bpp__hit_bone_name__pf);
			}
		case 9:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("half")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
			}
		case 10:
			{
		...
		case 12:
			{
				Super::bpf__take_damage__pf(bpp__val__pf, ((AActor*)nullptr), bpp__hit_bone_name__pf);
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		default:
...
PRAGMA_DISABLE_OPTIMIZATION
void Amidsize_enemy_C__pf839595025::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void Amidsize_enemy_C__pf839595025::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{206, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  AnimBlueprintGeneratedClass /Game/resouerce/Mannequin/Animations/ThirdPerson_AnimBP_armguard.ThirdPerson_AnimBP_armguard_C 
	};
	for(const FCompactBlueprintDependencyData& CompactData : LocCompactBlueprintDependencyData)
	{
		AssetsToLoad.Add(FBlueprintDependencyData(F__NativeDependencies::Get(CompactData.ObjectRefIndex), CompactData));
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__Amidsize_enemy_C__pf839595025
{
	FRegisterHelper__Amidsize_enemy_C__pf839595025()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/monster/midsize_enemy"), &Amidsize_enemy_C__pf839595025::__StaticDependenciesAssets);
	}
	static FRegisterHelper__Amidsize_enemy_C__pf839595025 Instance;
};
FRegisterHelper__Amidsize_enemy_C__pf839595025 FRegisterHelper__Amidsize_enemy_C__pf839595025::Instance;
