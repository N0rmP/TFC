...
Aterminal_C__pf3559600238::Aterminal_C__pf3559600238(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__tool_mesh__pf->VisibilityBasedAnimTickOption = EVisibilityBasedAnimTickOption::AlwaysTickPoseAndRefreshBones;
	bpv__tool_mesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__tool_mesh__pf->OverrideMaterials.Reserve(1);
	bpv__tool_mesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(Aterminal_C__pf3559600238::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed));
	...
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__tool_mesh__pf), false, 0));
	bpv__ScannedTower__pf = nullptr;
...
void Aterminal_C__pf3559600238::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void Aterminal_C__pf3559600238::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(Uwdg_towerBuild_C__pf3053510930::StaticClass());
	...
	InDynamicClass->ReferencedConvertedFields.Add(Uwdg_towerUpgrade_C__pf3053510930::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(ATower_C__pf711247040::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(Acore_C__pf937085289::StaticClass());
...
PRAGMA_ENABLE_OPTIMIZATION
void Aterminal_C__pf3559600238::bpf__left_click_on__pf()
{
	...
	bool bpfv__CallFunc_get_is_focussing_is_focussing_ret__pf{};
	...
	Uwdg_towerBuild_C__pf3053510930* bpfv__CallFunc_Create_ReturnValue__pf{};
	UClass* bpfv__CallFunc_GetObjectClass_ReturnValue__pf{};
	bool bpfv__CallFunc_EqualEqual_ClassClass_ReturnValue__pf{};
	ATowerBase_C__pf711247040* bpfv__K2Node_DynamicCast_AsTower_Base__pf{};
	...
	Uwdg_towerUpgrade_C__pf3053510930* bpfv__CallFunc_Create_ReturnValue_1__pf{};
	...
	do
	{
		...
		case 2:
			{
				bpfv__K2Node_DynamicCast_AsSniper_Tower__pf = Cast<ASniperTower_C__pf711247040>(bpfv__CallFunc_get_owners_linetracing_lintraced_actor__pf);
				bpfv__K2Node_DynamicCast_bSuccess_4__pf = (bpfv__K2Node_DynamicCast_AsSniper_Tower__pf != nullptr);;
		...
		case 3:
			{
				bpv__ScannedTower__pf = bpfv__K2Node_DynamicCast_AsSniper_Tower__pf;
			}
		case 4:
			{
				if(::IsValid(bpv__tool_owner__pf))
				{
					bpv__tool_owner__pf->bpf__get_is_focussing__pf(/*out*/ bpfv__CallFunc_get_is_focussing_is_focussing_ret__pf);
				}
			}
		case 5:
			{
				if (!bpfv__CallFunc_get_is_focussing_is_focussing_ret__pf)
				{
					__CurrentState = 21;
					break;
				}
		...
		case 6:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("Window Already Exists.")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
				__CurrentState = -1;
				break;
			}
		case 7:
			{
				bpfv__K2Node_DynamicCast_AsAo_ETower__pf = Cast<AAoETower_C__pf711247040>(bpfv__CallFunc_get_owners_linetracing_lintraced_actor__pf);
				bpfv__K2Node_DynamicCast_bSuccess_3__pf = (bpfv__K2Node_DynamicCast_AsAo_ETower__pf != nullptr);;
		...
		case 8:
			{
				bpv__ScannedTower__pf = bpfv__K2Node_DynamicCast_AsAo_ETower__pf;
				__CurrentState = 4;
				break;
			}
		case 9:
			{
				bpfv__K2Node_DynamicCast_AsBasic_Tower__pf = Cast<ABasicTower_C__pf711247040>(bpfv__CallFunc_get_owners_linetracing_lintraced_actor__pf);
				bpfv__K2Node_DynamicCast_bSuccess_2__pf = (bpfv__K2Node_DynamicCast_AsBasic_Tower__pf != nullptr);;
		...
		case 10:
			{
				bpv__ScannedTower__pf = bpfv__K2Node_DynamicCast_AsBasic_Tower__pf;
				__CurrentState = 4;
				break;
			}
		case 11:
			{
				bpfv__K2Node_DynamicCast_AsTower_Base__pf = Cast<ATowerBase_C__pf711247040>(bpfv__CallFunc_get_owners_linetracing_lintraced_actor__pf);
				bpfv__K2Node_DynamicCast_bSuccess_1__pf = (bpfv__K2Node_DynamicCast_AsTower_Base__pf != nullptr);;
		...
		case 12:
			{
				...
				bpfv__CallFunc_Create_ReturnValue__pf = CastChecked<Uwdg_towerBuild_C__pf3053510930>(UWidgetBlueprintLibrary::Create(this, Uwdg_towerBuild_C__pf3053510930::StaticClass(), bpfv__CallFunc_GetPlayerController_ReturnValue__pf), ECastCheckedType::NullAllowed);
			}
		case 13:
			{
				if(::IsValid(bpfv__CallFunc_Create_ReturnValue__pf))
				{
					bpfv__CallFunc_Create_ReturnValue__pf->bpf__setbase__pf(bpfv__K2Node_DynamicCast_AsTower_Base__pf, bpv__tool_owner__pf);
				}
			}
		case 14:
			{
				if(::IsValid(bpv__tool_owner__pf))
				{
					bpv__tool_owner__pf->bpf__set_is_focussing__pf(true);
				}
			}
		case 15:
			{
		...
		case 17:
			{
				bpfv__CallFunc_GetObjectClass_ReturnValue__pf = UGameplayStatics::GetObjectClass(bpfv__CallFunc_get_owners_linetracing_lintraced_actor__pf);
				bpfv__CallFunc_EqualEqual_ClassClass_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ClassClass(bpfv__CallFunc_GetObjectClass_ReturnValue__pf, Acore_C__pf937085289::StaticClass());
		...
		case 20:
			{
				...
				{
					bpfv__CallFunc_get_enemy_manager_enemy_manager_return__pf->bpf__set_time_until_next_wave__pf(0.001000);
				}
				__CurrentState = -1;
				break;
			}
		case 21:
			{
				bpfv__CallFunc_GetPlayerController_ReturnValue__pf = UGameplayStatics::GetPlayerController(this, 0);
				bpfv__CallFunc_Create_ReturnValue_1__pf = CastChecked<Uwdg_towerUpgrade_C__pf3053510930>(UWidgetBlueprintLibrary::Create(this, Uwdg_towerUpgrade_C__pf3053510930::StaticClass(), bpfv__CallFunc_GetPlayerController_ReturnValue__pf), ECastCheckedType::NullAllowed);
			}
		case 22:
			{
				if(::IsValid(bpfv__CallFunc_Create_ReturnValue_1__pf))
				{
					bpfv__CallFunc_Create_ReturnValue_1__pf->bpv__Tower__pf = bpv__ScannedTower__pf;
				}
			}
		case 23:
			{
		...
		case 25:
			{
				if(::IsValid(bpfv__CallFunc_Create_ReturnValue_1__pf))
				{
					bpfv__CallFunc_Create_ReturnValue_1__pf->bpv__Player__pf = bpv__tool_owner__pf;
				}
			}
		case 26:
			{
...
void Aterminal_C__pf3559600238::bpf__right_click_on__pf()
{
}
void Aterminal_C__pf3559600238::bpf__left_click_off__pf()
{
}
PRAGMA_DISABLE_OPTIMIZATION
void Aterminal_C__pf3559600238::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void Aterminal_C__pf3559600238::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{121, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/blueprints/player/tool/abst_tool.abst_tool_C 
		...
		{167, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/blueprints/UI/wdg_towerBuild.wdg_towerBuild_C 
		{157, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/blueprints/Tower/TowerBase.TowerBase_C 
		...
		{168, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/blueprints/UI/wdg_towerUpgrade.wdg_towerUpgrade_C 
		...
		{169, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/blueprints/others/core.core_C 
	};
	for(const FCompactBlueprintDependencyData& CompactData : LocCompactBlueprintDependencyData)
	{
		AssetsToLoad.Add(FBlueprintDependencyData(F__NativeDependencies::Get(CompactData.ObjectRefIndex), CompactData));
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__Aterminal_C__pf3559600238
{
	FRegisterHelper__Aterminal_C__pf3559600238()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/player/tool/terminal"), &Aterminal_C__pf3559600238::__StaticDependenciesAssets);
	}
	static FRegisterHelper__Aterminal_C__pf3559600238 Instance;
};
FRegisterHelper__Aterminal_C__pf3559600238 FRegisterHelper__Aterminal_C__pf3559600238::Instance;
