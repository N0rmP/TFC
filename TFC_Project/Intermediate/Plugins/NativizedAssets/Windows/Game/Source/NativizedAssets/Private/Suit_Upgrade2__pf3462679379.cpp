...
USuit_Upgrade2_C__pf3462679379::USuit_Upgrade2_C__pf3462679379(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__Next_Upgrades__pf = TArray<UClass*> ();
	bpv__Next_Upgrades__pf.Reserve(1);
	bpv__Next_Upgrades__pf.Add(USuit_Upgrade3_C__pf3462679379::StaticClass());
	bpv__prev_Upgrade__pf = USuit_Upgrade1_C__pf3462679379::StaticClass();
	bpv__upgrade_Tier__pf = 2;
	bpv__upgraded__pf = 2;
	bpv__Name__pf = FString(TEXT("RH-1-N-0 \ucd94\uc9c4\uae30"));
	bpv__Tool_Tip_Text__pf = FString(TEXT("\uc774\ub3d9 \uc18d\ub3c4 +100%"));
	bCanEverAffectNavigation = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void USuit_Upgrade2_C__pf3462679379::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void USuit_Upgrade2_C__pf3462679379::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void USuit_Upgrade2_C__pf3462679379::bpf__On_Added__pf()
{
	float bpfv__CallFunc_Multiply_IntFloat_ReturnValue__pf{};
	float  __Local__0 = 0.000000;
	bpfv__CallFunc_Multiply_IntFloat_ReturnValue__pf = UKismetMathLibrary::Multiply_IntFloat(2, ((::IsValid(bpv__suit__pf)) ? (bpv__suit__pf->bpv__run_speed__pf) : (__Local__0)));
	if(::IsValid(bpv__suit__pf))
	{
		bpv__suit__pf->bpv__run_speed__pf = bpfv__CallFunc_Multiply_IntFloat_ReturnValue__pf;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void USuit_Upgrade2_C__pf3462679379::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void USuit_Upgrade2_C__pf3462679379::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__USuit_Upgrade2_C__pf3462679379
{
	FRegisterHelper__USuit_Upgrade2_C__pf3462679379()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/OnCollections/Upgrades/Suit-upgrades/Suit_Upgrade2"), &USuit_Upgrade2_C__pf3462679379::__StaticDependenciesAssets);
	}
	static FRegisterHelper__USuit_Upgrade2_C__pf3462679379 Instance;
};
FRegisterHelper__USuit_Upgrade2_C__pf3462679379 FRegisterHelper__USuit_Upgrade2_C__pf3462679379::Instance;
