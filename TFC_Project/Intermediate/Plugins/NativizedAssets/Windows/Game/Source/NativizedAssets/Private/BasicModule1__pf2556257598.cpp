...
UBasicModule1_C__pf2556257598::UBasicModule1_C__pf2556257598(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__Name__pf = FString(TEXT("\uacf5\uaca9 \ubcf4\uc870 \ubaa8\ub4c81"));
	bpv__Tool_Tip_Text__pf = FString(TEXT("\uacf5\uaca9 \uc0ac\uac70\ub9ac +20%"));
	PrimaryComponentTick.bCanEverTick = true;
	bCanEverAffectNavigation = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void UBasicModule1_C__pf2556257598::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UBasicModule1_C__pf2556257598::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void UBasicModule1_C__pf2556257598::bpf__ExecuteUbergraph_BasicModule1__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 3:
			{
				...
				b2l__K2Node_DynamicCast_AsMain_Game_Instance__pf = Cast<UMain_GameInstance_C__pf3789721252>(bpfv__CallFunc_GetGameInstance_ReturnValue__pf);
				b2l__K2Node_DynamicCast_bSuccess__pf = (b2l__K2Node_DynamicCast_AsMain_Game_Instance__pf != nullptr);;
		...
		case 4:
			{
				if(::IsValid(b2l__K2Node_DynamicCast_AsMain_Game_Instance__pf))
				{
					b2l__K2Node_DynamicCast_AsMain_Game_Instance__pf->bpf__get_tower_manager__pf(/*out*/ b2l__CallFunc_get_tower_manager_tower_manager_return__pf);
				}
			}
		case 5:
			{
				if(::IsValid(b2l__CallFunc_get_tower_manager_tower_manager_return__pf))
				{
					b2l__CallFunc_get_tower_manager_tower_manager_return__pf->bpf__find_towers__pf(bpv__Owner__pf, /*out*/ b2l__CallFunc_find_towers_target_towers_return__pf);
				}
			}
		case 6:
			{
				bpfv__CallFunc_Array_Length_ReturnValue__pf = FCustomThunkTemplates::Array_Length(b2l__CallFunc_find_towers_target_towers_return__pf);
		...
		case 7:
			{
				bpfv__CallFunc_Array_Length_ReturnValue__pf = FCustomThunkTemplates::Array_Length(b2l__CallFunc_find_towers_target_towers_return__pf);
				bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf = UKismetMathLibrary::Subtract_IntInt(bpfv__CallFunc_Array_Length_ReturnValue__pf, 0);
				bpfv__CallFunc_Multiply_IntFloat_ReturnValue__pf = UKismetMathLibrary::Multiply_IntFloat(bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf, 0.150000);
				...
				if(::IsValid(bpv__Owner__pf))
				{
					bpv__Owner__pf->bpv__SPD_AMP__pf = bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf;
				}
				__CurrentState = -1;
				break;
			}
...
void UBasicModule1_C__pf2556257598::bpf__ExecuteUbergraph_BasicModule1__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 8);
	return; // KCST_GotoReturn
}
void UBasicModule1_C__pf2556257598::bpf__ExecuteUbergraph_BasicModule1__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	return; // KCST_GotoReturn
}
void UBasicModule1_C__pf2556257598::bpf__ReceiveActorBeginOverlap_1__pf(AActor* bpp__OtherActor__pf)
{
	b2l__K2Node_Event_OtherActor__pf = bpp__OtherActor__pf;
	bpf__ExecuteUbergraph_BasicModule1__pf_1(8);
}
void UBasicModule1_C__pf2556257598::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b2l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_BasicModule1__pf_0(2);
}
void UBasicModule1_C__pf2556257598::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BasicModule1__pf_2(1);
}
void UBasicModule1_C__pf2556257598::bpf__On_Added__pf()
{
	if(::IsValid(bpv__Owner__pf) && ::IsValid(bpv__Owner__pf->bpv__Range__pf))
	{
		bpv__Owner__pf->bpv__Range__pf->USceneComponent::SetWorldScale3D(FVector(1.200000,1.200000,1.200000));
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void UBasicModule1_C__pf2556257598::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UBasicModule1_C__pf2556257598::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{107, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/blueprints/OnCollections/Modules/Module.Module_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UBasicModule1_C__pf2556257598
{
	FRegisterHelper__UBasicModule1_C__pf2556257598()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/OnCollections/Modules/BasicModule1"), &UBasicModule1_C__pf2556257598::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UBasicModule1_C__pf2556257598 Instance;
};
FRegisterHelper__UBasicModule1_C__pf2556257598 FRegisterHelper__UBasicModule1_C__pf2556257598::Instance;
