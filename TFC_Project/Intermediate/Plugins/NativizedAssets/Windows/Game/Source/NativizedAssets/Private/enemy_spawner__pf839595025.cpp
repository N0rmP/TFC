...
Aenemy_spawner_C__pf839595025::Aenemy_spawner_C__pf839595025(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(Aenemy_spawner_C__pf839595025::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Cube__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Cube__pf->OverrideMaterials.Reserve(1);
	bpv__Cube__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(Aenemy_spawner_C__pf839595025::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__Cube__pf->SetCollisionProfileName(FName(TEXT("NoCollision")));
	...
	bpv__timer__pf = 0;
	bpv__enemylist__pf = TArray<Acreature_C__pf937085289*> ();
	bpv__success__pf = false;
...
void Aenemy_spawner_C__pf839595025::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void Aenemy_spawner_C__pf839595025::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void Aenemy_spawner_C__pf839595025::bpf__spawnxenemy__pfT(UClass* bpp__enemyxtype__pfT, /*out*/ Aenemy_base_C__pf839595025*& bpp__spawnedxenemy__pfT, /*out*/ bool& bpp__success__pf)
{
	...
	do
	{
		...
		case 2:
			{
				...
				bpfv__CallFunc_SpawnAIFromClass_ReturnValue__pf = UAIBlueprintHelperLibrary::SpawnAIFromClass(this, bpp__enemyxtype__pfT, ((UBehaviorTree*)nullptr), bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, FRotator(0.000000,0.000000,0.000000), false, ((AActor*)nullptr));
			}
		case 3:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Base__pf = Cast<Aenemy_base_C__pf839595025>(bpfv__CallFunc_SpawnAIFromClass_ReturnValue__pf);
		...
		case 4:
			{
				bpp__spawnedxenemy__pfT = bpfv__K2Node_DynamicCast_AsEnemy_Base__pf;
				bpp__success__pf = bpv__success__pf;
				__CurrentState = -1;
				break;
			}
		case 5:
...
PRAGMA_DISABLE_OPTIMIZATION
void Aenemy_spawner_C__pf839595025::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void Aenemy_spawner_C__pf839595025::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__Aenemy_spawner_C__pf839595025
{
	FRegisterHelper__Aenemy_spawner_C__pf839595025()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/monster/enemy_spawner"), &Aenemy_spawner_C__pf839595025::__StaticDependenciesAssets);
	}
	static FRegisterHelper__Aenemy_spawner_C__pf839595025 Instance;
};
FRegisterHelper__Aenemy_spawner_C__pf839595025 FRegisterHelper__Aenemy_spawner_C__pf839595025::Instance;
