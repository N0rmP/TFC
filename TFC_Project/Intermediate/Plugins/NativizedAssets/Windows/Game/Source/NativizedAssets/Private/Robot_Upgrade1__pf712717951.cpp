...
void URobot_Upgrade1_C__pf712717951::bpf__On_Added__pf()
{
	...
	bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Add_FloatFloat(((::IsValid(bpv__Robot__pf)) ? (bpv__Robot__pf->bpv__speedAmp__pf) : (__Local__0)), 0.200000);
