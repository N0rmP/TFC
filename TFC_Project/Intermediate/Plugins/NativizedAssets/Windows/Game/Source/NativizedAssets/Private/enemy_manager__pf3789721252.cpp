...
#include "enemy_spawner__pf839595025.h"
...
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/LowEntryExtendedStandardLibrary.h"
#include "Runtime/Engine/Classes/Engine/TextureRenderTarget2D.h"
#include "Runtime/Engine/Classes/Engine/TextureRenderTarget.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/ELowEntryImageFormat.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/ELowEntrySplitScreenTypeTwoPlayers.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/ELowEntrySplitScreenTypeThreePlayers.h"
...
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/FLowEntryRegexMatch.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/FLowEntryRegexCaptureGroup.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/LowEntryExecutionQueue.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/ClassesTypes/LowEntryLong.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/ClassesTypes/LowEntryDouble.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/LowEntryParsedHashcash.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/LowEntryByteArray.h"
...
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/ClassesLatentAction/LowEntryLatentActionString.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/ClassesLatentAction/LowEntryLatentActionObject.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/ClassesLatentAction/LowEntryLatentActionNone.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/ClassesLatentAction/LowEntryLatentActionInteger.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/ClassesLatentAction/LowEntryLatentActionFloat.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/ClassesLatentAction/LowEntryLatentActionBoolean.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/ELowEntryHmacAlgorithm.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/ELowEntrySplitScreenType.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/ELowEntryBatteryState.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/ELowEntryExtendedStandardLibrary0to9.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/ELowEntryExtendedStandardLibraryTrueOrFalse.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/ELowEntryExtendedStandardLibrary1to10other.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/LowEntryByteDataWriter.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/LowEntryByteDataEntry.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/LowEntryByteDataReader.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/LowEntryBitDataWriter.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/LowEntryBitDataEntry.h"
#include "../Plugins/Marketplace/LowEntryExtStdLib/Source/LowEntryExtendedStandardLibrary/Public/Classes/LowEntryBitDataReader.h"
...
Aenemy_manager_C__pf3789721252::Aenemy_manager_C__pf3789721252(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__enemies__pf = TArray<Aenemy_base_C__pf839595025*> ();
	bpv__enemy_spawners__pf = TArray<Aenemy_spawner_C__pf839595025*> ();
	bpv__cur_EST__pf = nullptr;
	bpv__EST_rows__pf = TArray<FName> ();
	bpv__cur_EST_index__pf = 0;
	bpv__time_until_next_wave__pf = 0.000000f;
	bpv__is_last_enemy_spawned__pf = false;
...
void Aenemy_manager_C__pf3789721252::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void Aenemy_manager_C__pf3789721252::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(Aenemy_spawner_C__pf839595025::StaticClass());
	...
	InDynamicClass->ReferencedConvertedFields.Add(AtestEnemy2_C__pf4098986762::StaticClass());
	// List of all referenced converted structures
	extern UScriptStruct* Z_Construct_UScriptStruct_Fenemy_spawn_table__pf3303916713();
	InDynamicClass->ReferencedConvertedFields.Add(Z_Construct_UScriptStruct_Fenemy_spawn_table__pf3303916713());
	FConvertedBlueprintsDependencies::FillUsedAssetsInDynamicClass(InDynamicClass, &__StaticDependencies_DirectlyUsedAssets);
}
PRAGMA_ENABLE_OPTIMIZATION
void Aenemy_manager_C__pf3789721252::bpf__ExecuteUbergraph_enemy_manager__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 22:
			{
				FCustomThunkTemplates::Array_Get(bpv__EST_rows__pf, bpv__cur_EST_index__pf, /*out*/ b0l__CallFunc_Array_Get_Item__pf);
				bpfv__CallFunc_GetDataTableRowFromName_ReturnValue__pf = FCustomThunkTemplates::GetDataTableRowFromName(bpv__cur_EST__pf, b0l__CallFunc_Array_Get_Item__pf, /*out*/ b0l__CallFunc_GetDataTableRowFromName_OutRow__pf);
			}
		case 23:
			{
		...
		case 24:
			{
				bpfv__CallFunc_GreaterEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::GreaterEqual_IntInt(b0l__CallFunc_GetDataTableRowFromName_OutRow__pf.bpv__spawner_number_11_D9EC7987499AE75356ADA6B55AD3834C__pf, 0);
		...
		case 25:
			{
				FCustomThunkTemplates::Array_Get(bpv__enemy_spawners__pf, b0l__CallFunc_GetDataTableRowFromName_OutRow__pf.bpv__spawner_number_11_D9EC7987499AE75356ADA6B55AD3834C__pf, /*out*/ b0l__CallFunc_Array_Get_Item_1__pf);
				if(::IsValid(b0l__CallFunc_Array_Get_Item_1__pf))
				{
					b0l__CallFunc_Array_Get_Item_1__pf->bpf__spawnxenemy__pfT(b0l__CallFunc_GetDataTableRowFromName_OutRow__pf.bpv__type_of_enemy_13_6C4414C446FC7862BC7F989DBC78A372__pf, /*out*/ b0l__CallFunc_spawn_enemy_spawned_enemy__pf, /*out*/ b0l__CallFunc_spawn_enemy_success__pf);
				}
			}
		case 26:
			{
				bpfv__CallFunc_Array_AddUnique_ReturnValue_1__pf = FCustomThunkTemplates::Array_AddUnique(bpv__enemies__pf, b0l__CallFunc_spawn_enemy_spawned_enemy__pf);
			}
		case 27:
			{
				bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(bpv__cur_EST_index__pf, 1);
				b0l_____int_Variable_1__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
			}
		case 28:
			{
				bpv__cur_EST_index__pf = b0l_____int_Variable_1__pf;
			}
		case 29:
			{
				bpfv__CallFunc_Array_Length_ReturnValue_2__pf = FCustomThunkTemplates::Array_Length(bpv__EST_rows__pf);
				bpfv__CallFunc_GreaterEqual_IntInt_ReturnValue_1__pf = UKismetMathLibrary::GreaterEqual_IntInt(b0l_____int_Variable_1__pf, bpfv__CallFunc_Array_Length_ReturnValue_2__pf);
		...
		case 30:
			{
				bpv__is_last_enemy_spawned__pf = true;
				__CurrentState = -1;
				break;
			}
		case 31:
			{
				bpv__time_until_next_wave__pf = b0l__CallFunc_GetDataTableRowFromName_OutRow__pf.bpv__delay_next_spawn_14_6DD67B354D00F6B56C6CB0BE9467BA70__pf;
			}
		case 32:
			{
				bpfv__CallFunc_Add_IntInt_ReturnValue_1__pf = UKismetMathLibrary::Add_IntInt(bpv__cur_EST_index__pf, 1);
				b0l_____int_Variable__pf = bpfv__CallFunc_Add_IntInt_ReturnValue_1__pf;
			}
		case 33:
			{
				bpv__cur_EST_index__pf = b0l_____int_Variable__pf;
				__CurrentState = -1;
				break;
			}
		case 34:
			{
				UKismetSystemLibrary::Delay(this, b0l__CallFunc_GetDataTableRowFromName_OutRow__pf.bpv__delay_next_spawn_14_6DD67B354D00F6B56C6CB0BE9467BA70__pf, FLatentActionInfo(2, 8570493, TEXT("ExecuteUbergraph_enemy_manager_0"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void Aenemy_manager_C__pf3789721252::bpf__ExecuteUbergraph_enemy_manager__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 35);
	// optimized KCST_UnconditionalGoto
	bpv__cur_EST__pf = b0l__K2Node_CustomEvent_cur_EST_param__pf;
	(b0l__CallFunc_GetDataTableRowNames_OutRowNames__pf).Reset();
	UDataTableFunctionLibrary::GetDataTableRowNames(bpv__cur_EST__pf, /*out*/ b0l__CallFunc_GetDataTableRowNames_OutRowNames__pf);
	bpv__EST_rows__pf = b0l__CallFunc_GetDataTableRowNames_OutRowNames__pf;
	// optimized KCST_UnconditionalGoto
	(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf).Reset();
	UGameplayStatics::GetAllActorsOfClass(this, Aenemy_spawner_C__pf839595025::StaticClass(), /*out*/ TArrayCaster<Aenemy_spawner_C__pf839595025*>(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf).Get<AActor*>());
	bpv__enemy_spawners__pf = b0l__CallFunc_GetAllActorsOfClass_OutActors__pf;
	bpv__cur_EST_index__pf = 0;
	// optimized KCST_UnconditionalGoto
	bpv__time_until_next_wave__pf = -1.000000;
	return; //KCST_EndOfThread
}
void Aenemy_manager_C__pf3789721252::bpf__ExecuteUbergraph_enemy_manager__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_Array_RemoveItem_ReturnValue__pf = FCustomThunkTemplates::Array_RemoveItem(bpv__enemies__pf, b0l__K2Node_CustomEvent_tar__pf);
	bpfv__CallFunc_Array_Length_ReturnValue__pf = FCustomThunkTemplates::Array_Length(bpv__enemies__pf);
	...
	bpfv__CallFunc_BooleanAND_ReturnValue__pf = UKismetMathLibrary::BooleanAND(bpfv__CallFunc_EqualEqual_IntInt_ReturnValue__pf, bpv__is_last_enemy_spawned__pf);
	...
	if(::IsValid(b0l__K2Node_DynamicCast_AsMain_Game_Instance__pf))
	{
		b0l__K2Node_DynamicCast_AsMain_Game_Instance__pf->bpf__level_end__pf(true);
	}
	return; //KCST_EndOfThread
}
void Aenemy_manager_C__pf3789721252::bpf__ExecuteUbergraph_enemy_manager__pf_3(int32 bpp__EntryPoint__pf)
{
	float bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf{};
	bool bpfv__CallFunc_LessEqual_FloatFloat_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 39);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Subtract_FloatFloat(bpv__time_until_next_wave__pf, b0l__K2Node_CustomEvent_delta_second__pf);
	bpv__time_until_next_wave__pf = bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf;
	bpfv__CallFunc_LessEqual_FloatFloat_ReturnValue__pf = UKismetMathLibrary::LessEqual_FloatFloat(bpv__time_until_next_wave__pf, 0.000000);
...
void Aenemy_manager_C__pf3789721252::bpf__ExecuteUbergraph_enemy_manager__pf_4(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 6:
			{
				bpfv__CallFunc_Greater_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Greater_FloatFloat(bpv__time_until_next_wave__pf, 0.000000);
		...
		case 7:
			{
				bpf__while_wave_stop__pf(b0l__K2Node_Event_DeltaSeconds__pf);
			}
		case 8:
			{
				bpfv__CallFunc_Array_Length_ReturnValue_1__pf = FCustomThunkTemplates::Array_Length(bpv__enemies__pf);
				bpfv__CallFunc_Greater_IntInt_ReturnValue__pf = UKismetMathLibrary::Greater_IntInt(bpfv__CallFunc_Array_Length_ReturnValue_1__pf, 1);
...
void Aenemy_manager_C__pf3789721252::bpf__ExecuteUbergraph_enemy_manager__pf_5(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 16);
	// optimized KCST_UnconditionalGoto
	FCustomThunkTemplates::Array_Clear(bpv__enemies__pf);
	return; //KCST_EndOfThread
}
void Aenemy_manager_C__pf3789721252::bpf__ExecuteUbergraph_enemy_manager__pf_6(int32 bpp__EntryPoint__pf)
{
	int32 bpfv__CallFunc_Array_AddUnique_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 9);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_Array_AddUnique_ReturnValue__pf = FCustomThunkTemplates::Array_AddUnique(bpv__enemies__pf, b0l__K2Node_CustomEvent_tar_1__pf);
	return; //KCST_EndOfThread
}
void Aenemy_manager_C__pf3789721252::bpf__while_wave_stop__pf(float bpp__deltaxsecond__pfT)
{
	b0l__K2Node_CustomEvent_delta_second__pf = bpp__deltaxsecond__pfT;
	bpf__ExecuteUbergraph_enemy_manager__pf_3(39);
}
void Aenemy_manager_C__pf3789721252::bpf__initiate_enemy_manager__pf(UDataTable* bpp__cur_EST_param__pf)
{
	b0l__K2Node_CustomEvent_cur_EST_param__pf = bpp__cur_EST_param__pf;
	bpf__ExecuteUbergraph_enemy_manager__pf_1(35);
}
void Aenemy_manager_C__pf3789721252::bpf__spawn_one_row__pf()
{
	bpf__ExecuteUbergraph_enemy_manager__pf_0(21);
}
void Aenemy_manager_C__pf3789721252::bpf__clear_enemies__pf()
{
	bpf__ExecuteUbergraph_enemy_manager__pf_5(16);
}
void Aenemy_manager_C__pf3789721252::bpf__remove_enemies_by_reference__pf(Aenemy_base_C__pf839595025* bpp__tar__pf)
{
	b0l__K2Node_CustomEvent_tar__pf = bpp__tar__pf;
	bpf__ExecuteUbergraph_enemy_manager__pf_2(11);
}
void Aenemy_manager_C__pf3789721252::bpf__add_enemies__pf(Aenemy_base_C__pf839595025* bpp__tar__pf)
{
	b0l__K2Node_CustomEvent_tar_1__pf = bpp__tar__pf;
	bpf__ExecuteUbergraph_enemy_manager__pf_6(9);
}
void Aenemy_manager_C__pf3789721252::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_enemy_manager__pf_4(5);
}
void Aenemy_manager_C__pf3789721252::bpf__UserConstructionScript__pf()
{
	TArray<Aenemy_base_C__pf839595025*> bpfv__CallFunc_GetAllActorsOfClass_OutActors__pf{};
	(bpfv__CallFunc_GetAllActorsOfClass_OutActors__pf).Reset();
	UGameplayStatics::GetAllActorsOfClass(this, Aenemy_base_C__pf839595025::StaticClass(), /*out*/ TArrayCaster<Aenemy_base_C__pf839595025*>(bpfv__CallFunc_GetAllActorsOfClass_OutActors__pf).Get<AActor*>());
	bpv__enemies__pf = bpfv__CallFunc_GetAllActorsOfClass_OutActors__pf;
}
void Aenemy_manager_C__pf3789721252::bpf__sort_enemy_by_health__pf()
{
	bool bpfv__is_loop__pf{};
	TArray<AtestEnemy2_C__pf4098986762*> bpfv__tempxenemies__pfT{};
	FDelegateULowEntryExtendedStandardLibraryCompareObjects bpfv__K2Node_CreateDelegate_OutputDelegate__pf{};
	bpfv__is_loop__pf = true;
	bpfv__K2Node_CreateDelegate_OutputDelegate__pf.BindUFunction(this,FName(TEXT("comparator_by_health")));
	ULowEntryExtendedStandardLibrary::SortObjectArrayDirectly(/*out*/ TArrayCaster<Aenemy_base_C__pf839595025*>(bpv__enemies__pf).Get<UObject*>(), bpfv__K2Node_CreateDelegate_OutputDelegate__pf, true);
}
void Aenemy_manager_C__pf3789721252::bpf__comparator_by_health__pf(UObject* bpp__ObjectA__pf, UObject* bpp__ObjectB__pf, /*out*/ bool& bpp__Return__pf)
{
	...
	do
	{
		...
		case 1:
			{
				bpfv__K2Node_DynamicCast_AsCreature__pf = Cast<Acreature_C__pf937085289>(bpp__ObjectA__pf);
		...
		case 2:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsCreature__pf) && ::IsValid(bpfv__K2Node_DynamicCast_AsCreature__pf->bpv__damagable__pf))
				{
					bpfv__K2Node_DynamicCast_AsCreature__pf->bpv__damagable__pf->bpf__get_cur_hp__pf(/*out*/ bpfv__CallFunc_get_cur_hp_cur_hp_res__pf);
				}
			}
		case 3:
			{
				bpfv__K2Node_DynamicCast_AsCreature_1__pf = Cast<Acreature_C__pf937085289>(bpp__ObjectB__pf);
		...
		case 4:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsCreature_1__pf) && ::IsValid(bpfv__K2Node_DynamicCast_AsCreature_1__pf->bpv__damagable__pf))
				{
					bpfv__K2Node_DynamicCast_AsCreature_1__pf->bpv__damagable__pf->bpf__get_cur_hp__pf(/*out*/ bpfv__CallFunc_get_cur_hp_cur_hp_res_1__pf);
				}
			}
		case 5:
			{
				bpfv__CallFunc_Less_IntInt_ReturnValue__pf = UKismetMathLibrary::Less_IntInt(bpfv__CallFunc_get_cur_hp_cur_hp_res__pf, bpfv__CallFunc_get_cur_hp_cur_hp_res_1__pf);
				bpp__Return__pf = bpfv__CallFunc_Less_IntInt_ReturnValue__pf;
				__CurrentState = -1;
				break;
			}
		default:
...
void Aenemy_manager_C__pf3789721252::bpf__get_enemies__pf(/*out*/ TArray<Aenemy_base_C__pf839595025*>& bpp__enemies_return__pf)
{
	bpp__enemies_return__pf = bpv__enemies__pf;
}
void Aenemy_manager_C__pf3789721252::bpf__remove_enemy__pf(Aenemy_base_C__pf839595025* bpp__tar__pf)
{
	bool bpfv__CallFunc_Array_RemoveItem_ReturnValue__pf{};
	bpfv__CallFunc_Array_RemoveItem_ReturnValue__pf = FCustomThunkTemplates::Array_RemoveItem(bpv__enemies__pf, bpp__tar__pf);
}
void Aenemy_manager_C__pf3789721252::bpf__get_time_until_next_wave__pf(/*out*/ float& bpp__time_until_next_wave_ret__pf)
{
	bpp__time_until_next_wave_ret__pf = bpv__time_until_next_wave__pf;
}
void Aenemy_manager_C__pf3789721252::bpf__set_time_until_next_wave__pf(float bpp__val__pf)
{
	bpv__time_until_next_wave__pf = bpp__val__pf;
}
PRAGMA_DISABLE_OPTIMIZATION
void Aenemy_manager_C__pf3789721252::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void Aenemy_manager_C__pf3789721252::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{150, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/blueprints/monster/enemy_spawner.enemy_spawner_C 
		...
		{110, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/blueprints/others/damagable.damagable_C 
		{129, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/blueprints/monster/test/testEnemy2.testEnemy2_C 
		{151, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  UserDefinedStruct /Game/blueprints/others/excel/enemy_spawn_table.enemy_spawn_table 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__Aenemy_manager_C__pf3789721252
{
	FRegisterHelper__Aenemy_manager_C__pf3789721252()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/others/Observer/enemy_manager"), &Aenemy_manager_C__pf3789721252::__StaticDependenciesAssets);
	}
	static FRegisterHelper__Aenemy_manager_C__pf3789721252 Instance;
};
FRegisterHelper__Aenemy_manager_C__pf3789721252 FRegisterHelper__Aenemy_manager_C__pf3789721252::Instance;
