...
USuit_Upgrade_C__pf77128533::USuit_Upgrade_C__pf77128533(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__suit__pf = nullptr;
	bpv__upgraded__pf = 1;
	bCanEverAffectNavigation = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void USuit_Upgrade_C__pf77128533::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void USuit_Upgrade_C__pf77128533::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void USuit_Upgrade_C__pf77128533::bpf__ExecuteUbergraph_Suit_Upgrade__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	return; // KCST_GotoReturn
}
void USuit_Upgrade_C__pf77128533::bpf__ReceiveActorBeginOverlap_1__pf(AActor* bpp__OtherActor__pf)
{
	b2l__K2Node_Event_OtherActor__pf = bpp__OtherActor__pf;
	bpf__ExecuteUbergraph_Suit_Upgrade__pf_0(1);
}
void USuit_Upgrade_C__pf77128533::bpf__On_Added__pf()
{
}
void USuit_Upgrade_C__pf77128533::bpf__On_Attacked__pf()
{
	Super::bpf__On_Attacked__pf();
}
void USuit_Upgrade_C__pf77128533::bpf__Set_Owner__pf(Aplayer_character_C__pf2509438801* bpp__player__pf)
{
	bpv__suit__pf = bpp__player__pf;
}
PRAGMA_DISABLE_OPTIMIZATION
void USuit_Upgrade_C__pf77128533::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void USuit_Upgrade_C__pf77128533::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__USuit_Upgrade_C__pf77128533
{
	FRegisterHelper__USuit_Upgrade_C__pf77128533()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/OnCollections/Upgrades/Suit_Upgrade"), &USuit_Upgrade_C__pf77128533::__StaticDependenciesAssets);
	}
	static FRegisterHelper__USuit_Upgrade_C__pf77128533 Instance;
};
FRegisterHelper__USuit_Upgrade_C__pf77128533 FRegisterHelper__USuit_Upgrade_C__pf77128533::Instance;
