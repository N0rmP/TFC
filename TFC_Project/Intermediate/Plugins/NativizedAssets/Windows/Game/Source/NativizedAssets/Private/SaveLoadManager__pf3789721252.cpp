...
USaveLoadManager_C__pf3789721252::USaveLoadManager_C__pf3789721252(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__Slot_Name__pf = FString(TEXT(""));
	bpv__user_ID__pf = 0;
	bpv__NewVar_0__pf = 0;
	bpv__upgrade_manager__pf = nullptr;
}
PRAGMA_ENABLE_OPTIMIZATION
void USaveLoadManager_C__pf3789721252::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void USaveLoadManager_C__pf3789721252::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void USaveLoadManager_C__pf3789721252::bpf__ExecuteUbergraph_SaveLoadManager__pf(int32 bpp__EntryPoint__pf)
{
...
void USaveLoadManager_C__pf3789721252::bpf__On_Init__pf()
{
}
void USaveLoadManager_C__pf3789721252::bpf__Save_Game__pf()
{
	bool bpfv__CallFunc_SaveGameToSlot_ReturnValue__pf{};
	bpfv__CallFunc_SaveGameToSlot_ReturnValue__pf = UGameplayStatics::SaveGameToSlot(this, bpv__Slot_Name__pf, 0);
}
void USaveLoadManager_C__pf3789721252::bpf__save_Upgrades__pf(UWidget* bpp__widget__pf)
{
	...
	do
	{
		...
		case 1:
			{
				if(::IsValid(bpp__widget__pf))
				{
					bpfv__CallFunc_GetGameInstance_ReturnValue__pf = bpp__widget__pf->UWidget::GetGameInstance();
				}
		...
		case 2:
			{
				Aupgrade_Manager_C__pf3789721252*  __Local__0 = ((Aupgrade_Manager_C__pf3789721252*)nullptr);
				bpv__upgrade_manager__pf = ((::IsValid(bpfv__K2Node_DynamicCast_AsMain_Game_Instance__pf)) ? (bpfv__K2Node_DynamicCast_AsMain_Game_Instance__pf->bpv__upgrade_manager__pf) : (__Local__0));
			}
		case 3:
			{
				bpfv__CallFunc_SaveGameToSlot_ReturnValue__pf = UGameplayStatics::SaveGameToSlot(this, bpv__Slot_Name__pf, 0);
...
PRAGMA_DISABLE_OPTIMIZATION
void USaveLoadManager_C__pf3789721252::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void USaveLoadManager_C__pf3789721252::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{37, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.SaveGame 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__USaveLoadManager_C__pf3789721252
{
	FRegisterHelper__USaveLoadManager_C__pf3789721252()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/others/Observer/SaveLoadManager"), &USaveLoadManager_C__pf3789721252::__StaticDependenciesAssets);
	}
	static FRegisterHelper__USaveLoadManager_C__pf3789721252 Instance;
};
FRegisterHelper__USaveLoadManager_C__pf3789721252 FRegisterHelper__USaveLoadManager_C__pf3789721252::Instance;
