...
URobot_Upgrade2_2_C__pf712717951::URobot_Upgrade2_2_C__pf712717951(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bCanEverAffectNavigation = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void URobot_Upgrade2_2_C__pf712717951::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void URobot_Upgrade2_2_C__pf712717951::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void URobot_Upgrade2_2_C__pf712717951::bpf__On_Added__pf()
{
	UStaticMeshComponent* bpfv__CallFunc_GetComponentByClass_ReturnValue__pf{};
	...
	do
	{
		...
		case 1:
			{
				if(::IsValid(bpv__Robot__pf) && ::IsValid(bpv__Robot__pf->bpv__robot_range__pf))
				{
					bpfv__CallFunc_GetComponentByClass_ReturnValue__pf = CastChecked<UStaticMeshComponent>(bpv__Robot__pf->bpv__robot_range__pf->AActor::GetComponentByClass(UStaticMeshComponent::StaticClass()), ECastCheckedType::NullAllowed);
				}
		...
		case 2:
			{
				...
				{
					bpfv__CallFunc_GetComponentByClass_ReturnValue__pf->SetAllMassScale(1.200000);
				}
				__CurrentState = -1;
				break;
			}
...
PRAGMA_DISABLE_OPTIMIZATION
void URobot_Upgrade2_2_C__pf712717951::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void URobot_Upgrade2_2_C__pf712717951::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{116, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/blueprints/OnCollections/Upgrades/Robot_Upgrade.Robot_Upgrade_C 
		...
		{158, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/blueprints/Robot/Robot_range.Robot_range_C 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__URobot_Upgrade2_2_C__pf712717951
{
	FRegisterHelper__URobot_Upgrade2_2_C__pf712717951()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/OnCollections/Upgrades/Robot-upgrades/Robot_Upgrade2_2"), &URobot_Upgrade2_2_C__pf712717951::__StaticDependenciesAssets);
	}
	static FRegisterHelper__URobot_Upgrade2_2_C__pf712717951 Instance;
};
FRegisterHelper__URobot_Upgrade2_2_C__pf712717951 FRegisterHelper__URobot_Upgrade2_2_C__pf712717951::Instance;
