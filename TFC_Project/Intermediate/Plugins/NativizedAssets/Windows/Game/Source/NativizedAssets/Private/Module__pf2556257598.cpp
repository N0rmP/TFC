...
UModule_C__pf2556257598::UModule_C__pf2556257598(const FObjectInitializer& ObjectInitializer) : Super()
{
...
void UModule_C__pf2556257598::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UModule_C__pf2556257598::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void UModule_C__pf2556257598::bpf__On_Added__pf()
{
}
void UModule_C__pf2556257598::bpf__On_Search__pf()
{
	Super::bpf__On_Search__pf();
}
void UModule_C__pf2556257598::bpf__On_Attack__pf()
{
	Super::bpf__On_Attack__pf();
}
void UModule_C__pf2556257598::bpf__SetOwner__pf(ATower_C__pf711247040* bpp__tower__pf)
{
	bpv__Owner__pf = bpp__tower__pf;
}
PRAGMA_DISABLE_OPTIMIZATION
void UModule_C__pf2556257598::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UModule_C__pf2556257598::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UModule_C__pf2556257598
{
	FRegisterHelper__UModule_C__pf2556257598()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/OnCollections/Modules/Module"), &UModule_C__pf2556257598::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UModule_C__pf2556257598 Instance;
};
FRegisterHelper__UModule_C__pf2556257598 FRegisterHelper__UModule_C__pf2556257598::Instance;
