...
Uwdg_stagemenu_C__pf3053510930::Uwdg_stagemenu_C__pf3053510930(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__button_Stage_0__pf = nullptr;
	bpv__button_Stage_1__pf = nullptr;
	bpv__button_Stage_2__pf = nullptr;
	bpv__button_Stage_3__pf = nullptr;
	bpv__button_Stage_4__pf = nullptr;
	bpv__button_Stage_5__pf = nullptr;
	bpv__Image_142__pf = nullptr;
	bpv__Image_248__pf = nullptr;
	bpv__PlayerUpgrade__pf = nullptr;
	bpv__wdg_stageInfo__pf = nullptr;
	bHasScriptImplementedTick = false;
	bHasScriptImplementedPaint = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void Uwdg_stagemenu_C__pf3053510930::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void Uwdg_stagemenu_C__pf3053510930::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UwdgxplrUpgrade_C__pfG3053510930::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(Uwdg_stageInfo_C__pf3053510930::StaticClass());
	...
	__Local__2.ComponentPropertyName = FName(TEXT("PlayerUpgrade"));
	__Local__2.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__2.FunctionNameToBind = FName(TEXT("BndEvt__wdg_stagemenu_PlayerUpgrade_K2Node_ComponentBoundEvent_6_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__3 = __Local__0->ComponentDelegateBindings[1];
	__Local__3.ComponentPropertyName = FName(TEXT("button_Stage_5"));
	__Local__3.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__3.FunctionNameToBind = FName(TEXT("BndEvt__wdg_stagemenu_button_Stage_5_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__4 = __Local__0->ComponentDelegateBindings[2];
	__Local__4.ComponentPropertyName = FName(TEXT("button_Stage_4"));
	__Local__4.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__4.FunctionNameToBind = FName(TEXT("BndEvt__wdg_stagemenu_button_Stage_4_K2Node_ComponentBoundEvent_4_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__5 = __Local__0->ComponentDelegateBindings[3];
	__Local__5.ComponentPropertyName = FName(TEXT("button_Stage_3"));
	__Local__5.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__5.FunctionNameToBind = FName(TEXT("BndEvt__wdg_stagemenu_button_Stage_3_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__6 = __Local__0->ComponentDelegateBindings[4];
	__Local__6.ComponentPropertyName = FName(TEXT("button_Stage_2"));
	__Local__6.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__6.FunctionNameToBind = FName(TEXT("BndEvt__wdg_stagemenu_button_Stage_2_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__7 = __Local__0->ComponentDelegateBindings[5];
	__Local__7.ComponentPropertyName = FName(TEXT("button_Stage_1"));
	__Local__7.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__7.FunctionNameToBind = FName(TEXT("BndEvt__wdg_stagemenu_button_Stage_1_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__8 = __Local__0->ComponentDelegateBindings[6];
	__Local__8.ComponentPropertyName = FName(TEXT("button_Stage_0"));
	__Local__8.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__8.FunctionNameToBind = FName(TEXT("BndEvt__wdg_stagemenu_button_Stage_0_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	__Local__11->LayoutData.Anchors.Maximum = FVector2D(1.000000, 1.000000);
	__Local__11->Parent = __Local__9;
	auto __Local__12 = NewObject<UImage>(__Local__1, TEXT("Image_142"), (EObjectFlags)0x00280008);
	__Local__12->Slot = __Local__11;
	__Local__11->Content = __Local__12;
	__Local__10.Add(__Local__11);
	auto __Local__13 = NewObject<UCanvasPanelSlot>(__Local__9, TEXT("CanvasPanelSlot_80"), (EObjectFlags)0x00280008);
	__Local__13->LayoutData.Offsets.Left = -935.000000f;
	__Local__13->LayoutData.Offsets.Top = -300.000000f;
	__Local__13->LayoutData.Offsets.Right = 1200.000000f;
	__Local__13->LayoutData.Offsets.Bottom = 800.000000f;
	...
	auto __Local__14 = NewObject<UImage>(__Local__1, TEXT("Image_248"), (EObjectFlags)0x00280008);
	__Local__14->Brush.ImageSize = FVector2D(1050.000000, 619.000000);
	auto& __Local__15 = (*(AccessPrivateProperty<UObject* >(&(__Local__14->Brush), FSlateBrush::__PPO__ResourceObject() )));
	__Local__15 = CastChecked<UObject>(CastChecked<UDynamicClass>(Uwdg_stagemenu_C__pf3053510930::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
...
void Uwdg_stagemenu_C__pf3053510930::bpf__ExecuteUbergraph_wdg_stagemenu__pf_0(int32 bpp__EntryPoint__pf)
{
	APlayerController* bpfv__CallFunc_GetPlayerController_ReturnValue__pf{};
	UwdgxplrUpgrade_C__pfG3053510930* bpfv__CallFunc_Create_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 16);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_GetPlayerController_ReturnValue__pf = UGameplayStatics::GetPlayerController(this, 0);
	bpfv__CallFunc_Create_ReturnValue__pf = CastChecked<UwdgxplrUpgrade_C__pfG3053510930>(UWidgetBlueprintLibrary::Create(this, UwdgxplrUpgrade_C__pfG3053510930::StaticClass(), bpfv__CallFunc_GetPlayerController_ReturnValue__pf), ECastCheckedType::NullAllowed);
...
void Uwdg_stagemenu_C__pf3053510930::bpf__ExecuteUbergraph_wdg_stagemenu__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 14);
	// optimized KCST_UnconditionalGoto
	bpf__OpenInfo__pf(bpv__button_Stage_5__pf);
	return; // KCST_GotoReturn
}
void Uwdg_stagemenu_C__pf3053510930::bpf__ExecuteUbergraph_wdg_stagemenu__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 12);
	// optimized KCST_UnconditionalGoto
	bpf__OpenInfo__pf(bpv__button_Stage_4__pf);
	return; // KCST_GotoReturn
}
void Uwdg_stagemenu_C__pf3053510930::bpf__ExecuteUbergraph_wdg_stagemenu__pf_3(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 10);
	// optimized KCST_UnconditionalGoto
	bpf__OpenInfo__pf(bpv__button_Stage_3__pf);
	return; // KCST_GotoReturn
}
void Uwdg_stagemenu_C__pf3053510930::bpf__ExecuteUbergraph_wdg_stagemenu__pf_4(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 8);
	// optimized KCST_UnconditionalGoto
	bpf__OpenInfo__pf(bpv__button_Stage_2__pf);
	return; // KCST_GotoReturn
}
void Uwdg_stagemenu_C__pf3053510930::bpf__ExecuteUbergraph_wdg_stagemenu__pf_5(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 6);
	// optimized KCST_UnconditionalGoto
	bpf__OpenInfo__pf(bpv__button_Stage_1__pf);
	return; // KCST_GotoReturn
}
void Uwdg_stagemenu_C__pf3053510930::bpf__ExecuteUbergraph_wdg_stagemenu__pf_6(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 4);
	// optimized KCST_UnconditionalGoto
	bpf__OpenInfo__pf(bpv__button_Stage_0__pf);
	return; // KCST_GotoReturn
}
void Uwdg_stagemenu_C__pf3053510930::bpf__ExecuteUbergraph_wdg_stagemenu__pf_7(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 3);
	return; // KCST_GotoReturn
}
void Uwdg_stagemenu_C__pf3053510930::bpf__BndEvt__wdg_stagemenu_PlayerUpgrade_K2Node_ComponentBoundEvent_6_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_wdg_stagemenu__pf_0(16);
}
void Uwdg_stagemenu_C__pf3053510930::bpf__BndEvt__wdg_stagemenu_button_Stage_5_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_wdg_stagemenu__pf_1(14);
}
void Uwdg_stagemenu_C__pf3053510930::bpf__BndEvt__wdg_stagemenu_button_Stage_4_K2Node_ComponentBoundEvent_4_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_wdg_stagemenu__pf_2(12);
}
void Uwdg_stagemenu_C__pf3053510930::bpf__BndEvt__wdg_stagemenu_button_Stage_3_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_wdg_stagemenu__pf_3(10);
}
void Uwdg_stagemenu_C__pf3053510930::bpf__BndEvt__wdg_stagemenu_button_Stage_2_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_wdg_stagemenu__pf_4(8);
}
void Uwdg_stagemenu_C__pf3053510930::bpf__BndEvt__wdg_stagemenu_button_Stage_1_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_wdg_stagemenu__pf_5(6);
}
void Uwdg_stagemenu_C__pf3053510930::bpf__BndEvt__wdg_stagemenu_button_Stage_0_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_wdg_stagemenu__pf_6(4);
}
void Uwdg_stagemenu_C__pf3053510930::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_wdg_stagemenu__pf_7(3);
}
void Uwdg_stagemenu_C__pf3053510930::bpf__OpenInfo__pf(UButton* bpp__NewParam__pf)
{
	...
	if(::IsValid(bpv__wdg_stageInfo__pf))
	{
		bpv__wdg_stageInfo__pf->bpf__SetStagename__pf(bpfv__CallFunc_Conv_StringToInt_ReturnValue__pf);
	}
	if(::IsValid(bpv__wdg_stageInfo__pf))
	{
		bpv__wdg_stageInfo__pf->SetVisibility(ESlateVisibility::Visible);
	}
}
void Uwdg_stagemenu_C__pf3053510930::bpf__EnablexBtns__pfT(bool bpp__NewParam__pf)
{
	if(::IsValid(bpv__button_Stage_0__pf))
	{
		bpv__button_Stage_0__pf->SetIsEnabled(bpp__NewParam__pf);
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void Uwdg_stagemenu_C__pf3053510930::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void Uwdg_stagemenu_C__pf3053510930::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__Uwdg_stagemenu_C__pf3053510930
{
	FRegisterHelper__Uwdg_stagemenu_C__pf3053510930()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/UI/wdg_stagemenu"), &Uwdg_stagemenu_C__pf3053510930::__StaticDependenciesAssets);
	}
	static FRegisterHelper__Uwdg_stagemenu_C__pf3053510930 Instance;
};
FRegisterHelper__Uwdg_stagemenu_C__pf3053510930 FRegisterHelper__Uwdg_stagemenu_C__pf3053510930::Instance;
