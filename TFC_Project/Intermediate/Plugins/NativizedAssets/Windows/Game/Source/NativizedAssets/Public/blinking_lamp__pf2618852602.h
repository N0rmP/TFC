...
#include "blinking_lamp__pf2618852602.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/resouerce/mesh/blinking_lamp.blinking_lamp_C", OverrideNativeName="blinking_lamp_C"))
class Ablinking_lamp_C__pf2618852602 : public AActor
{
public:
	GENERATED_BODY()
	...
	Ablinking_lamp_C__pf2618852602(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
