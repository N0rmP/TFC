...
URifle_Upgrade2_C__pf1870350606::URifle_Upgrade2_C__pf1870350606(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__Next_Upgrades__pf = TArray<UClass*> ();
	bpv__Next_Upgrades__pf.Reserve(1);
	bpv__Next_Upgrades__pf.Add(URifle_Upgrade3_C__pf1870350606::StaticClass());
	bpv__prev_Upgrade__pf = URifle_Upgrade1_C__pf1870350606::StaticClass();
	bpv__upgrade_Tier__pf = 2;
	bpv__upgraded__pf = 2;
	bpv__Name__pf = FString(TEXT("HC \uac1c\ub7c9 \ud655\uc7a5 \ud0c4\ucc3d"));
	bpv__Tool_Tip_Text__pf = FString(TEXT("\ud0c4\ucc3d +80%"));
	bCanEverAffectNavigation = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void URifle_Upgrade2_C__pf1870350606::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void URifle_Upgrade2_C__pf1870350606::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void URifle_Upgrade2_C__pf1870350606::bpf__On_Added__pf()
{
	float bpfv__CallFunc_Multiply_IntFloat_ReturnValue__pf{};
	int32 bpfv__CallFunc_FTrunc_ReturnValue__pf{};
	int32  __Local__0 = 0;
	bpfv__CallFunc_Multiply_IntFloat_ReturnValue__pf = UKismetMathLibrary::Multiply_IntFloat(((::IsValid(bpv__rifle__pf)) ? (bpv__rifle__pf->bpv__max_ammo__pf) : (__Local__0)), 1.800000);
	...
	{
		bpv__rifle__pf->bpv__max_ammo__pf = bpfv__CallFunc_FTrunc_ReturnValue__pf;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void URifle_Upgrade2_C__pf1870350606::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void URifle_Upgrade2_C__pf1870350606::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__URifle_Upgrade2_C__pf1870350606
{
	FRegisterHelper__URifle_Upgrade2_C__pf1870350606()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/OnCollections/Upgrades/Rifle-upgrades/Rifle_Upgrade2"), &URifle_Upgrade2_C__pf1870350606::__StaticDependenciesAssets);
	}
	static FRegisterHelper__URifle_Upgrade2_C__pf1870350606 Instance;
};
FRegisterHelper__URifle_Upgrade2_C__pf1870350606 FRegisterHelper__URifle_Upgrade2_C__pf1870350606::Instance;
