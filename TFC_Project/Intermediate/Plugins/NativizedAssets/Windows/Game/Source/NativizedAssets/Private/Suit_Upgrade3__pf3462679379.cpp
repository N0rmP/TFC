...
USuit_Upgrade3_C__pf3462679379::USuit_Upgrade3_C__pf3462679379(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__prev_Upgrade__pf = USuit_Upgrade2_C__pf3462679379::StaticClass();
	bpv__upgrade_Tier__pf = 2;
	bpv__upgraded__pf = 2;
	bpv__Name__pf = FString(TEXT("\ubc29\uc5b4\ub9c9 \ucd9c\ub825 \uac15\ud654"));
	bpv__Tool_Tip_Text__pf = FString(TEXT("\ucd5c\ub300 \uccb4\ub825 +150"));
	bCanEverAffectNavigation = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void USuit_Upgrade3_C__pf3462679379::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void USuit_Upgrade3_C__pf3462679379::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void USuit_Upgrade3_C__pf3462679379::bpf__On_Added__pf()
{
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	int32  __Local__0 = 0;
	bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(((::IsValid(bpv__suit__pf)) ? (bpv__suit__pf->bpv__plr_max_hp__pf) : (__Local__0)), 150);
	if(::IsValid(bpv__suit__pf))
	{
		bpv__suit__pf->bpv__plr_max_hp__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void USuit_Upgrade3_C__pf3462679379::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void USuit_Upgrade3_C__pf3462679379::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__USuit_Upgrade3_C__pf3462679379
{
	FRegisterHelper__USuit_Upgrade3_C__pf3462679379()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/OnCollections/Upgrades/Suit-upgrades/Suit_Upgrade3"), &USuit_Upgrade3_C__pf3462679379::__StaticDependenciesAssets);
	}
	static FRegisterHelper__USuit_Upgrade3_C__pf3462679379 Instance;
};
FRegisterHelper__USuit_Upgrade3_C__pf3462679379 FRegisterHelper__USuit_Upgrade3_C__pf3462679379::Instance;
