...
#include "ThirdPerson_AnimBP__pf4051366165.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/resouerce/Mannequin/Animations/ThirdPerson_AnimBP.ThirdPerson_AnimBP_C", OverrideNativeName="ThirdPerson_AnimBP_C"))
class UThirdPerson_AnimBP_C__pf4051366165 : public UAnimInstance
{
public:
	GENERATED_BODY()
	...
	UThirdPerson_AnimBP_C__pf4051366165(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
