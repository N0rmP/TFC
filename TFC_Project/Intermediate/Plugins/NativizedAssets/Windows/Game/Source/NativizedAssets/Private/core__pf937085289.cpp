...
Acore_C__pf937085289::Acore_C__pf937085289(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	if(__Local__0)
	{
		...
		__Local__0->ComponentTags.Add(FName(TEXT("core")));
	...
	if(__Local__2)
	{
		...
		{
			__Local__14 = (UPrimitiveComponent::StaticClass())->FindPropertyByName(FName(TEXT("bGenerateOverlapEvents")));
			check(__Local__14);
	...
	bpv__Core__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Core"));
	bpv__Core__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Core__pf->AttachToComponent(__Local__2, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__19 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Core__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__19 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(Acore_C__pf937085289::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Core__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Core__pf->OverrideMaterials.Reserve(1);
	bpv__Core__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(Acore_C__pf937085289::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	auto& __Local__20 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__Core__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__20 = ECollisionChannel::ECC_Pawn;
	auto& __Local__21 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__Core__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__21 = ECollisionEnabled::Type::PhysicsOnly;
	bpv__Core__pf->BodyInstance.bNotifyRigidBodyCollision = true;
	bpv__Core__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__22 = (*(AccessPrivateProperty<FVector >((bpv__Core__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__22 = FVector(0.000000, 0.000000, -40.000000);
	...
	(((FBoolProperty*)__Local__23)->SetPropertyValue_InContainer((bpv__Core__pf), true, 0));
	...
	Tags = TArray<FName> ();
	Tags.Reserve(1);
	Tags.Add(FName(TEXT("core")));
}
PRAGMA_ENABLE_OPTIMIZATION
void Acore_C__pf937085289::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void Acore_C__pf937085289::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void Acore_C__pf937085289::bpf__die__pf()
{
...
PRAGMA_DISABLE_OPTIMIZATION
void Acore_C__pf937085289::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void Acore_C__pf937085289::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__Acore_C__pf937085289
{
	FRegisterHelper__Acore_C__pf937085289()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/others/core"), &Acore_C__pf937085289::__StaticDependenciesAssets);
	}
	static FRegisterHelper__Acore_C__pf937085289 Instance;
};
FRegisterHelper__Acore_C__pf937085289 FRegisterHelper__Acore_C__pf937085289::Instance;
