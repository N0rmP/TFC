...
UEffect_C__pf3439682450::UEffect_C__pf3439682450(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__Owner__pf = nullptr;
	bpv__Duration__pf = 1.000000f;
	bpv__Stack__pf = 0;
	bpv__MaxStack__pf = 0;
	bpv__Timer__pf = 1.000000f;
	bpv__isStackable__pf = false;
	PrimaryComponentTick.bCanEverTick = true;
	bCanEverAffectNavigation = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void UEffect_C__pf3439682450::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UEffect_C__pf3439682450::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void UEffect_C__pf3439682450::bpf__ExecuteUbergraph_Effect__pf_0(int32 bpp__EntryPoint__pf)
{
	bool bpfv__CallFunc_LessEqual_FloatFloat_ReturnValue__pf{};
	float bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 1);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Subtract_FloatFloat(bpv__Timer__pf, b1l__K2Node_Event_DeltaSeconds__pf);
	bpv__Timer__pf = bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf;
	bpfv__CallFunc_LessEqual_FloatFloat_ReturnValue__pf = UKismetMathLibrary::LessEqual_FloatFloat(bpv__Timer__pf, 0.000000);
...
void UEffect_C__pf3439682450::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b1l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_Effect__pf_0(1);
}
void UEffect_C__pf3439682450::bpf__On_Added__pf()
{
	bpv__Stack__pf = 1;
	bpv__Timer__pf = bpv__Duration__pf;
}
void UEffect_C__pf3439682450::bpf__On_Attacked__pf()
{
}
void UEffect_C__pf3439682450::bpf__On_CreatureDie__pf()
{
}
void UEffect_C__pf3439682450::bpf__On_Stacked__pf()
{
	...
	do
	{
		...
		case 2:
			{
				bpfv__CallFunc_Less_IntInt_ReturnValue__pf = UKismetMathLibrary::Less_IntInt(bpv__Stack__pf, bpv__MaxStack__pf);
		...
		case 3:
			{
				bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(bpv__Stack__pf, 1);
				bpv__Stack__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
			}
		case 4:
			{
				bpv__Timer__pf = bpv__Duration__pf;
...
void UEffect_C__pf3439682450::bpf__On_Die__pf()
{
}
void UEffect_C__pf3439682450::bpf__Set_Owner__pf(Acreature_C__pf937085289* bpp__Owner__pf)
{
	bpv__Owner__pf = bpp__Owner__pf;
}
PRAGMA_DISABLE_OPTIMIZATION
void UEffect_C__pf3439682450::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UEffect_C__pf3439682450::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{114, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/blueprints/OnCollections/OnCollection.OnCollection_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UEffect_C__pf3439682450
{
	FRegisterHelper__UEffect_C__pf3439682450()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/OnCollections/Effects/Effect"), &UEffect_C__pf3439682450::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UEffect_C__pf3439682450 Instance;
};
FRegisterHelper__UEffect_C__pf3439682450 FRegisterHelper__UEffect_C__pf3439682450::Instance;
