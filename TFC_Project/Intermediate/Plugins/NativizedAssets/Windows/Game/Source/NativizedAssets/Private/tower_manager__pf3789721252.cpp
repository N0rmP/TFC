...
Atower_manager_C__pf3789721252::Atower_manager_C__pf3789721252(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__towers__pf = TArray<ATower_C__pf711247040*> ();
	bpv__tower_bases__pf = TArray<ATowerBase_C__pf711247040*> ();
...
void Atower_manager_C__pf3789721252::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void Atower_manager_C__pf3789721252::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void Atower_manager_C__pf3789721252::bpf__ExecuteUbergraph_tower_manager__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	// optimized KCST_UnconditionalGoto
	(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf).Reset();
	UGameplayStatics::GetAllActorsOfClass(this, ATowerBase_C__pf711247040::StaticClass(), /*out*/ TArrayCaster<ATowerBase_C__pf711247040*>(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf).Get<AActor*>());
	bpv__tower_bases__pf = b0l__CallFunc_GetAllActorsOfClass_OutActors__pf;
	return; // KCST_GotoReturn
}
void Atower_manager_C__pf3789721252::bpf__ExecuteUbergraph_tower_manager__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 6);
	// optimized KCST_UnconditionalGoto
	FCustomThunkTemplates::Array_Clear(bpv__tower_bases__pf);
	FCustomThunkTemplates::Array_Clear(bpv__towers__pf);
	return; // KCST_GotoReturn
}
void Atower_manager_C__pf3789721252::bpf__ExecuteUbergraph_tower_manager__pf_2(int32 bpp__EntryPoint__pf)
{
	bool bpfv__CallFunc_Array_RemoveItem_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 9);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_Array_RemoveItem_ReturnValue__pf = FCustomThunkTemplates::Array_RemoveItem(bpv__towers__pf, b0l__K2Node_CustomEvent_tower__pf);
	return; // KCST_GotoReturn
}
void Atower_manager_C__pf3789721252::bpf__ExecuteUbergraph_tower_manager__pf_3(int32 bpp__EntryPoint__pf)
{
	int32 bpfv__CallFunc_Array_AddUnique_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 7);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_Array_AddUnique_ReturnValue__pf = FCustomThunkTemplates::Array_AddUnique(bpv__towers__pf, b0l__K2Node_CustomEvent_tower_1__pf);
	return; // KCST_GotoReturn
}
void Atower_manager_C__pf3789721252::bpf__remove_tower_by_reference__pf(ATower_C__pf711247040* bpp__tower__pf)
{
	b0l__K2Node_CustomEvent_tower__pf = bpp__tower__pf;
	bpf__ExecuteUbergraph_tower_manager__pf_2(9);
}
void Atower_manager_C__pf3789721252::bpf__add_tower__pf(ATower_C__pf711247040* bpp__tower__pf)
{
	b0l__K2Node_CustomEvent_tower_1__pf = bpp__tower__pf;
	bpf__ExecuteUbergraph_tower_manager__pf_3(7);
}
void Atower_manager_C__pf3789721252::bpf__clear_towers__pf()
{
	bpf__ExecuteUbergraph_tower_manager__pf_1(6);
}
void Atower_manager_C__pf3789721252::bpf__initiation__pf()
{
	bpf__ExecuteUbergraph_tower_manager__pf_0(1);
}
void Atower_manager_C__pf3789721252::bpf__get_towers_list__pf(/*out*/ TArray<ATower_C__pf711247040*>& bpp__towers_res__pf)
{
	bpp__towers_res__pf = bpv__towers__pf;
}
void Atower_manager_C__pf3789721252::bpf__find_towers__pf(ATower_C__pf711247040* bpp__type_of_tower__pf, /*out*/ TArray<ATower_C__pf711247040*>& bpp__target_towers_return__pf)
{
	TArray<ATower_C__pf711247040*> bpfv__return_arr__pf{};
	UClass* bpfv__target_type_of_tower__pf{};
	...
	ATower_C__pf711247040* bpfv__CallFunc_Array_Get_Item__pf{};
	...
	do
	{
		...
		case 1:
			{
				bpfv__CallFunc_GetObjectClass_ReturnValue__pf = UGameplayStatics::GetObjectClass(bpp__type_of_tower__pf);
				bpfv__target_type_of_tower__pf = bpfv__CallFunc_GetObjectClass_ReturnValue__pf;
			}
		case 2:
			{
		...
		case 4:
			{
				bpfv__CallFunc_Array_Length_ReturnValue__pf = FCustomThunkTemplates::Array_Length(bpv__towers__pf);
		...
		case 7:
			{
				FCustomThunkTemplates::Array_Get(bpv__towers__pf, bpfv_____int_Array_Index_Variable__pf, /*out*/ bpfv__CallFunc_Array_Get_Item__pf);
				bpfv__CallFunc_GetObjectClass_ReturnValue_1__pf = UGameplayStatics::GetObjectClass(bpfv__CallFunc_Array_Get_Item__pf);
				bpfv__CallFunc_EqualEqual_ClassClass_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ClassClass(bpfv__CallFunc_GetObjectClass_ReturnValue_1__pf, bpfv__target_type_of_tower__pf);
		...
		case 8:
			{
				FCustomThunkTemplates::Array_Get(bpv__towers__pf, bpfv_____int_Array_Index_Variable__pf, /*out*/ bpfv__CallFunc_Array_Get_Item__pf);
				bpfv__CallFunc_Array_Add_ReturnValue__pf = FCustomThunkTemplates::Array_Add(bpfv__return_arr__pf, bpfv__CallFunc_Array_Get_Item__pf);
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 9:
			{
				bpp__target_towers_return__pf = bpfv__return_arr__pf;
				__CurrentState = -1;
				break;
			}
		case 10:
...
PRAGMA_DISABLE_OPTIMIZATION
void Atower_manager_C__pf3789721252::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void Atower_manager_C__pf3789721252::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__Atower_manager_C__pf3789721252
{
	FRegisterHelper__Atower_manager_C__pf3789721252()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/others/Observer/tower_manager"), &Atower_manager_C__pf3789721252::__StaticDependenciesAssets);
	}
	static FRegisterHelper__Atower_manager_C__pf3789721252 Instance;
};
FRegisterHelper__Atower_manager_C__pf3789721252 FRegisterHelper__Atower_manager_C__pf3789721252::Instance;
