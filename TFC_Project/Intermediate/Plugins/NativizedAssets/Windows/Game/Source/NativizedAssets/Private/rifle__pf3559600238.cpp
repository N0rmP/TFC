...
Arifle_C__pf3559600238::Arifle_C__pf3559600238(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__max_ammo__pf = 30;
	bpv__cur_ammo__pf = 0;
	bpv__damage_per_bullet__pf = 10;
	bpv__automatic_fire_delay__pf = 0.330000f;
	bpv__zoom_FOV_angle__pf = 30.000000f;
	bpv__is_aiming__pf = false;
	bpv__is_sniper_firable__pf = true;
	bpv__sniper_fire_delay__pf = 1.000000f;
	bpv__reload_time__pf = 1.000000f;
...
void Arifle_C__pf3559600238::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void Arifle_C__pf3559600238::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	(((FBoolProperty*)__Local__2)->SetPropertyValue_InContainer((__Local__1), false, 0));
}
PRAGMA_ENABLE_OPTIMIZATION
void Arifle_C__pf3559600238::bpf__UserConstructionScript__pf()
{
	/*This function cannot be called from BP. See bIsValidFunction in UObject::CallFunction*/
	bpv__cur_ammo__pf = bpv__max_ammo__pf;
}
void Arifle_C__pf3559600238::bpf__left_click_on__pf()
{
	...
	do
	{
		...
		case 2:
			{
				bpfv__CallFunc_GreaterEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::GreaterEqual_IntInt(bpv__cur_ammo__pf, 3);
				bpfv__CallFunc_BooleanAND_ReturnValue__pf = UKismetMathLibrary::BooleanAND(bpv__is_sniper_firable__pf, bpfv__CallFunc_GreaterEqual_IntInt_ReturnValue__pf);
		...
		case 3:
			{
				bpf__sniper_fire__pf();
				__CurrentState = -1;
				break;
			}
		case 4:
			{
				bpfv__CallFunc_K2_SetTimer_ReturnValue__pf = UKismetSystemLibrary::K2_SetTimer(this, FString(TEXT("automatic_fire")), bpv__automatic_fire_delay__pf, true, -0.330000, 0.000000);
			}
		case 5:
			{
				bpv__automatic_fire_handle__pf = bpfv__CallFunc_K2_SetTimer_ReturnValue__pf;
				__CurrentState = -1;
				break;
			}
		case 6:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("cannot fire")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
				__CurrentState = -1;
				break;
			}
		default:
...
void Arifle_C__pf3559600238::bpf__left_click_off__pf()
{
	FTimerHandle bpfv__CallFunc_K2_InvalidateTimerHandle_ReturnValue__pf{};
	UKismetSystemLibrary::K2_ClearAndInvalidateTimerHandle(this, /*out*/ bpv__automatic_fire_handle__pf);
	bpfv__CallFunc_K2_InvalidateTimerHandle_ReturnValue__pf = UKismetSystemLibrary::K2_InvalidateTimerHandle(/*out*/ bpv__automatic_fire_handle__pf);
}
void Arifle_C__pf3559600238::bpf__right_click_on__pf()
{
	if(::IsValid(bpv__tool_owner__pf))
	{
		bpv__tool_owner__pf->bpf__set_zoom__pf(bpv__zoom_FOV_angle__pf);
	}
	bpv__is_aiming__pf = true;
	UKismetSystemLibrary::K2_ClearAndInvalidateTimerHandle(this, /*out*/ bpv__automatic_fire_handle__pf);
}
void Arifle_C__pf3559600238::bpf__right_click_off__pf()
{
	if(::IsValid(bpv__tool_owner__pf))
	{
		bpv__tool_owner__pf->bpf__set_zoom__pf(90.000000);
	}
	bpv__is_aiming__pf = false;
}
void Arifle_C__pf3559600238::bpf__R_button__pf()
{
	FTimerHandle bpfv__CallFunc_K2_SetTimer_ReturnValue__pf{};
	bpfv__CallFunc_K2_SetTimer_ReturnValue__pf = UKismetSystemLibrary::K2_SetTimer(this, FString(TEXT("reload")), bpv__reload_time__pf, false, 0.000000, 0.000000);
	if(::IsValid(bpv__tool_owner__pf))
	{
		bpv__tool_owner__pf->bpf__set_is_reloading__pf(true);
	}
}
void Arifle_C__pf3559600238::bpf__fire__pf(int32 bpp__damage__pf)
{
	...
	Aline_manager_C__pf3789721252* bpfv__CallFunc_get_line_manager_line_manager_return__pf{};
	AActor* bpfv__CallFunc_get_owners_linetracing_lintraced_actor__pf{};
	FName bpfv__CallFunc_get_owners_linetracing_linetraced_hit_bone__pf{};
	FVector bpfv__CallFunc_get_owners_linetracing_linetraced_location__pf(EForceInit::ForceInit);
	...
	do
	{
		...
		case 1:
			{
				bpf__get_owners_linetracing__pf(/*out*/ bpfv__CallFunc_get_owners_linetracing_lintraced_actor__pf, /*out*/ bpfv__CallFunc_get_owners_linetracing_linetraced_hit_bone__pf, /*out*/ bpfv__CallFunc_get_owners_linetracing_linetraced_location__pf);
			}
		case 2:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Base__pf = Cast<Aenemy_base_C__pf839595025>(bpfv__CallFunc_get_owners_linetracing_lintraced_actor__pf);
				bpfv__K2Node_DynamicCast_bSuccess_1__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Base__pf != nullptr);;
		...
		case 3:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Base__pf->bpf__take_damage__pf(bpp__damage__pf, bpv__tool_owner__pf, bpfv__CallFunc_get_owners_linetracing_linetraced_hit_bone__pf);
				}
			}
		case 4:
			{
		...
		case 5:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsMain_Game_Instance__pf->bpf__get_line_manager__pf(/*out*/ bpfv__CallFunc_get_line_manager_line_manager_return__pf);
				}
			}
		case 6:
			{
				if(::IsValid(bpv__tool_mesh__pf))
				{
					bpfv__CallFunc_GetSocketLocation_ReturnValue__pf = bpv__tool_mesh__pf->GetSocketLocation(FName(TEXT("muzzle")));
				}
				if(::IsValid(bpfv__CallFunc_get_line_manager_line_manager_return__pf))
				{
					bpfv__CallFunc_get_line_manager_line_manager_return__pf->bpf__place_line__pf(bpfv__CallFunc_GetSocketLocation_ReturnValue__pf, bpfv__CallFunc_get_owners_linetracing_linetraced_location__pf);
				}
				__CurrentState = -1;
				break;
			}
...
void Arifle_C__pf3559600238::bpf__automatic_fire__pf()
{
	...
	do
	{
		...
		case 1:
			{
				bpfv__CallFunc_Greater_IntInt_ReturnValue__pf = UKismetMathLibrary::Greater_IntInt(bpv__cur_ammo__pf, 0);
		...
		case 2:
			{
				bpf__fire__pf(bpv__damage_per_bullet__pf);
			}
		case 3:
			{
				bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf = UKismetMathLibrary::Subtract_IntInt(bpv__cur_ammo__pf, 1);
				bpv__cur_ammo__pf = bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf;
				__CurrentState = -1;
				break;
			}
		case 4:
			{
				bpf__left_click_off__pf();
				__CurrentState = -1;
				break;
			}
		default:
...
void Arifle_C__pf3559600238::bpf__sniper_fire__pf()
{
	int32 bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf{};
	FTimerHandle bpfv__CallFunc_K2_SetTimer_ReturnValue__pf{};
	int32 bpfv__CallFunc_Multiply_IntInt_ReturnValue__pf{};
	bpfv__CallFunc_Multiply_IntInt_ReturnValue__pf = UKismetMathLibrary::Multiply_IntInt(bpv__damage_per_bullet__pf, 3);
	bpf__fire__pf(bpfv__CallFunc_Multiply_IntInt_ReturnValue__pf);
	bpv__is_sniper_firable__pf = false;
	bpfv__CallFunc_K2_SetTimer_ReturnValue__pf = UKismetSystemLibrary::K2_SetTimer(this, FString(TEXT("sniper_delay_done")), bpv__sniper_fire_delay__pf, false, 0.000000, 0.000000);
	bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf = UKismetMathLibrary::Subtract_IntInt(bpv__cur_ammo__pf, 3);
	bpv__cur_ammo__pf = bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf;
}
void Arifle_C__pf3559600238::bpf__sniper_delay_done__pf()
{
	bpv__is_sniper_firable__pf = true;
}
void Arifle_C__pf3559600238::bpf__reload__pf()
{
	bpv__cur_ammo__pf = bpv__max_ammo__pf;
	UKismetSystemLibrary::PrintString(this, FString(TEXT("RELOAD COMPLETE")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
	if(::IsValid(bpv__tool_owner__pf))
	{
		bpv__tool_owner__pf->bpf__set_is_reloading__pf(false);
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void Arifle_C__pf3559600238::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void Arifle_C__pf3559600238::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{117, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/blueprints/player/tool/abst_tool.abst_tool_C 
		...
		{47, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ScriptStruct /Script/Engine.TimerHandle 
		...
		{119, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/blueprints/others/Observer/line_manager.line_manager_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__Arifle_C__pf3559600238
{
	FRegisterHelper__Arifle_C__pf3559600238()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/player/tool/rifle"), &Arifle_C__pf3559600238::__StaticDependenciesAssets);
	}
	static FRegisterHelper__Arifle_C__pf3559600238 Instance;
};
FRegisterHelper__Arifle_C__pf3559600238 FRegisterHelper__Arifle_C__pf3559600238::Instance;
