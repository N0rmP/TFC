...
AAoEEffect_C__pf711247040::AAoEEffect_C__pf711247040(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__Effect__pf = CreateDefaultSubobject<UParticleSystemComponent>(TEXT("Effect"));
	...
	bpv__Effect__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Effect__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__Effect__pf->Template = CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(AAoEEffect_C__pf711247040::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__2 = (*(AccessPrivateProperty<FRotator >((bpv__Effect__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__2 = FRotator(-89.999985, -1079.998291, 1619.998047);
	auto& __Local__3 = (*(AccessPrivateProperty<FVector >((bpv__Effect__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__3 = FVector(3.000000, 3.000000, 5.000000);
	bpv__Effect__pf->PrimaryComponentTick.bStartWithTickEnabled = false;
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Effect__pf), false, 0));
	...
	auto& __Local__4 = (*(AccessPrivateProperty<FVector >((bpv__Collision__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__4 = FVector(-40.000000, 0.000262, 0.000019);
	auto& __Local__5 = (*(AccessPrivateProperty<FRotator >((bpv__Collision__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__5 = FRotator(-90.000000, 359.841858, 180.157974);
	auto& __Local__6 = (*(AccessPrivateProperty<FVector >((bpv__Collision__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__6 = FVector(1.500000, 1.500000, 1.500000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Collision__pf), true, 0));
	bpv__lifespan__pf = 0.000000f;
	bpv__lifetime__pf = 0.000000f;
	bpv__AlreadyHit__pf = TArray<AtestEnemy2_C__pf4098986762*> ();
	...
	InitialLifeSpan = 1.000000f;
}
PRAGMA_ENABLE_OPTIMIZATION
void AAoEEffect_C__pf711247040::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AAoEEffect_C__pf711247040::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__9.ComponentPropertyName = FName(TEXT("Collision"));
	__Local__9.DelegatePropertyName = FName(TEXT("OnComponentHit"));
	__Local__9.FunctionNameToBind = FName(TEXT("BndEvt__Collision_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AAoEEffect_C__pf711247040::bpf__ExecuteUbergraph_AoEEffect__pf_0(int32 bpp__EntryPoint__pf)
{
	bool bpfv__CallFunc_LessEqual_FloatFloat_ReturnValue__pf{};
	float bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 9);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Subtract_FloatFloat(bpv__lifetime__pf, b0l__K2Node_Event_DeltaSeconds__pf);
	bpv__lifetime__pf = bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf;
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_LessEqual_FloatFloat_ReturnValue__pf = UKismetMathLibrary::LessEqual_FloatFloat(bpv__lifetime__pf, 0.000000);
...
void AAoEEffect_C__pf711247040::bpf__ExecuteUbergraph_AoEEffect__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	// optimized KCST_UnconditionalGoto
	b0l__K2Node_DynamicCast_AsTest_Enemy_2__pf = Cast<AtestEnemy2_C__pf4098986762>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
	b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsTest_Enemy_2__pf != nullptr);;
	if (!b0l__K2Node_DynamicCast_bSuccess__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	bpfv__CallFunc_Array_Find_ReturnValue__pf = FCustomThunkTemplates::Array_Find(bpv__AlreadyHit__pf, b0l__K2Node_DynamicCast_AsTest_Enemy_2__pf);
	bpfv__CallFunc_EqualEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::EqualEqual_IntInt(bpfv__CallFunc_Array_Find_ReturnValue__pf, -1);
	if (!bpfv__CallFunc_EqualEqual_IntInt_ReturnValue__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	bpfv__CallFunc_Array_Add_ReturnValue__pf = FCustomThunkTemplates::Array_Add(bpv__AlreadyHit__pf, b0l__K2Node_DynamicCast_AsTest_Enemy_2__pf);
	UKismetSystemLibrary::PrintString(this, FString(TEXT("Call Damage Function")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
	return; // KCST_GotoReturn
}
void AAoEEffect_C__pf711247040::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_AoEEffect__pf_0(9);
}
void AAoEEffect_C__pf711247040::bpf__BndEvt__Collision_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__HitComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, FVector bpp__NormalImpulse__pf, FHitResult const& bpp__Hit__pf__const)
{
	...
	bpf__ExecuteUbergraph_AoEEffect__pf_1(3);
}
void AAoEEffect_C__pf711247040::bpf__UserConstructionScript__pf()
{
	bpv__lifetime__pf = bpv__lifespan__pf;
}
PRAGMA_DISABLE_OPTIMIZATION
void AAoEEffect_C__pf711247040::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AAoEEffect_C__pf711247040::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{78, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.ParticleSystemComponent 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AAoEEffect_C__pf711247040
{
	FRegisterHelper__AAoEEffect_C__pf711247040()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/Tower/AoEEffect"), &AAoEEffect_C__pf711247040::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AAoEEffect_C__pf711247040 Instance;
};
FRegisterHelper__AAoEEffect_C__pf711247040 FRegisterHelper__AAoEEffect_C__pf711247040::Instance;
