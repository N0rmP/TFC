...
class AActor;
#include "BasicModule4__pf2556257598.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/blueprints/OnCollections/Modules/BasicModule4.BasicModule4_C", OverrideNativeName="BasicModule4_C"))
class UBasicModule4_C__pf2556257598 : public UModule_C__pf2556257598
{
public:
	GENERATED_BODY()
	...
	UBasicModule4_C__pf2556257598(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_BasicModule4__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_BasicModule4__pf_1(int32 bpp__EntryPoint__pf);
