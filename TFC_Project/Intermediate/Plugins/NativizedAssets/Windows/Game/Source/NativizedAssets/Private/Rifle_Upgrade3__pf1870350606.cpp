...
URifle_Upgrade3_C__pf1870350606::URifle_Upgrade3_C__pf1870350606(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__prev_Upgrade__pf = URifle_Upgrade2_C__pf1870350606::StaticClass();
	bpv__upgrade_Tier__pf = 3;
	bpv__upgraded__pf = 2;
	bpv__Name__pf = FString(TEXT("D-5F \uc81c\uc555\ud0c4"));
	bpv__Tool_Tip_Text__pf = FString(TEXT("\uacf5\uaca9\uc73c\ub85c \uc778\ud55c \uacbd\uc9c1 \ud6a8\uacfc +50%."));
	bCanEverAffectNavigation = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void URifle_Upgrade3_C__pf1870350606::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void URifle_Upgrade3_C__pf1870350606::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void URifle_Upgrade3_C__pf1870350606::bpf__On_Added__pf()
{
}
PRAGMA_DISABLE_OPTIMIZATION
void URifle_Upgrade3_C__pf1870350606::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void URifle_Upgrade3_C__pf1870350606::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__URifle_Upgrade3_C__pf1870350606
{
	FRegisterHelper__URifle_Upgrade3_C__pf1870350606()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/OnCollections/Upgrades/Rifle-upgrades/Rifle_Upgrade3"), &URifle_Upgrade3_C__pf1870350606::__StaticDependenciesAssets);
	}
	static FRegisterHelper__URifle_Upgrade3_C__pf1870350606 Instance;
};
FRegisterHelper__URifle_Upgrade3_C__pf1870350606 FRegisterHelper__URifle_Upgrade3_C__pf1870350606::Instance;
