...
#include "SlowEffect__pf3439682450.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/blueprints/OnCollections/Effects/SlowEffect.SlowEffect_C", OverrideNativeName="SlowEffect_C"))
class USlowEffect_C__pf3439682450 : public UEffect_C__pf3439682450
{
public:
	GENERATED_BODY()
	...
	USlowEffect_C__pf3439682450(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
