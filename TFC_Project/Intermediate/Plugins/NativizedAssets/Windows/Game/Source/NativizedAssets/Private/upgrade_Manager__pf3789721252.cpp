...
#include "Base_Upgrade__pf77128533.h"
...
Aupgrade_Manager_C__pf3789721252::Aupgrade_Manager_C__pf3789721252(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__root_Upgrade__pf = UBase_Upgrade_C__pf77128533::StaticClass();
...
void Aupgrade_Manager_C__pf3789721252::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void Aupgrade_Manager_C__pf3789721252::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UBase_Upgrade_C__pf77128533::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(UUpgrade_C__pf77128533::StaticClass());
	FConvertedBlueprintsDependencies::FillUsedAssetsInDynamicClass(InDynamicClass, &__StaticDependencies_DirectlyUsedAssets);
}
PRAGMA_ENABLE_OPTIMIZATION
void Aupgrade_Manager_C__pf3789721252::bpf__ExecuteUbergraph_upgrade_Manager__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 2);
	// optimized KCST_UnconditionalGoto
	bpf__InitxUpgrades__pfT(bpv__root_Upgrade__pf);
	// optimized KCST_UnconditionalGoto
	UKismetSystemLibrary::PrintString(this, FString(TEXT("iwanttoknowwhenigotosleep")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
	return; // KCST_GotoReturn
}
void Aupgrade_Manager_C__pf3789721252::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_upgrade_Manager__pf_0(2);
}
void Aupgrade_Manager_C__pf3789721252::bpf__get_Upgrade_Tree__pf(/*out*/ UBase_Upgrade_C__pf77128533*& bpp__tree__pf)
{
	UBase_Upgrade_C__pf77128533* bpfv__CallFunc_GetComponentByClass_ReturnValue__pf{};
	bpfv__CallFunc_GetComponentByClass_ReturnValue__pf = CastChecked<UBase_Upgrade_C__pf77128533>(AActor::GetComponentByClass(UBase_Upgrade_C__pf77128533::StaticClass()), ECastCheckedType::NullAllowed);
	bpp__tree__pf = bpfv__CallFunc_GetComponentByClass_ReturnValue__pf;
}
void Aupgrade_Manager_C__pf3789721252::bpf__get_Upgraded__pf(/*out*/ TArray<UClass*>& bpp__upgraded__pf)
{
	TArray<UClass*> bpfv__temp_Upgraded__pf{};
	int32 bpfv_____int_Array_Index_Variable__pf{};
	int32 bpfv_____int_Loop_Counter_Variable__pf{};
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	TArray<UUpgrade_C__pf77128533*> bpfv__CallFunc_K2_GetComponentsByClass_ReturnValue__pf{};
	UUpgrade_C__pf77128533* bpfv__CallFunc_Array_Get_Item__pf{};
	...
	do
	{
		...
		case 3:
			{
				bpfv__CallFunc_K2_GetComponentsByClass_ReturnValue__pf = TArrayCaster<UActorComponent*>(AActor::K2_GetComponentsByClass(UUpgrade_C__pf77128533::StaticClass())).Get<UUpgrade_C__pf77128533*>();
		...
		case 6:
			{
				...
				int32  __Local__3 = 0;
				bpfv__CallFunc_EqualEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::EqualEqual_IntInt(((::IsValid(bpfv__CallFunc_Array_Get_Item__pf)) ? (bpfv__CallFunc_Array_Get_Item__pf->bpv__upgraded__pf) : (__Local__3)), 0);
		...
		case 7:
			{
				bpfv__CallFunc_K2_GetComponentsByClass_ReturnValue__pf = TArrayCaster<UActorComponent*>(AActor::K2_GetComponentsByClass(UUpgrade_C__pf77128533::StaticClass())).Get<UUpgrade_C__pf77128533*>();
				FCustomThunkTemplates::Array_Get(bpfv__CallFunc_K2_GetComponentsByClass_ReturnValue__pf, bpfv_____int_Array_Index_Variable__pf, /*out*/ bpfv__CallFunc_Array_Get_Item__pf);
				bpfv__CallFunc_GetObjectClass_ReturnValue__pf = UGameplayStatics::GetObjectClass(bpfv__CallFunc_Array_Get_Item__pf);
				bpfv__CallFunc_Array_Add_ReturnValue__pf = FCustomThunkTemplates::Array_Add(bpfv__temp_Upgraded__pf, bpfv__CallFunc_GetObjectClass_ReturnValue__pf);
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 8:
			{
				bpp__upgraded__pf = bpfv__temp_Upgraded__pf;
				__CurrentState = -1;
				break;
			}
		case 9:
...
void Aupgrade_Manager_C__pf3789721252::bpf__Upgrade__pf(UUpgrade_C__pf77128533* bpp__Upgrade__pf, /*out*/ bool& bpp__succeed__pf)
{
	bool bpfv__K2Node_SwitchInteger_CmpSuccess__pf{};
	int32 bpfv__CallFunc_Array_Length_ReturnValue__pf{};
	bool bpfv__CallFunc_Upgrade_This_succeed__pf{};
	int32 bpfv_____int_Array_Index_Variable__pf{};
	UClass* bpfv__CallFunc_Array_Get_Item__pf{};
	UUpgrade_C__pf77128533* bpfv__CallFunc_GetComponentByClass_ReturnValue__pf{};
	int32 bpfv_____int_Loop_Counter_Variable__pf{};
	bool bpfv__CallFunc_Less_IntInt_ReturnValue__pf{};
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	TArray< int32, TInlineAllocator<8> > __StateStack;
	...
	do
	{
		...
		case 1:
			{
				if(::IsValid(bpp__Upgrade__pf))
				{
					bpp__Upgrade__pf->bpf__Upgrade_This__pf(/*out*/ bpfv__CallFunc_Upgrade_This_succeed__pf);
				}
			}
		case 2:
			{
				if (!bpfv__CallFunc_Upgrade_This_succeed__pf)
				{
					__CurrentState = 9;
					break;
				}
		...
		case 5:
			{
				TArray<UClass*>  __Local__4 = {};
				bpfv__CallFunc_Array_Length_ReturnValue__pf = FCustomThunkTemplates::Array_Length(((::IsValid(bpp__Upgrade__pf)) ? (bpp__Upgrade__pf->bpv__Next_Upgrades__pf) : (__Local__4)));
				bpfv__CallFunc_Less_IntInt_ReturnValue__pf = UKismetMathLibrary::Less_IntInt(bpfv_____int_Loop_Counter_Variable__pf, bpfv__CallFunc_Array_Length_ReturnValue__pf);
				if (!bpfv__CallFunc_Less_IntInt_ReturnValue__pf)
				{
					__CurrentState = 13;
		...
		case 8:
			{
				TArray<UClass*>  __Local__5 = {};
				FCustomThunkTemplates::Array_Get(((::IsValid(bpp__Upgrade__pf)) ? (bpp__Upgrade__pf->bpv__Next_Upgrades__pf) : (__Local__5)), bpfv_____int_Array_Index_Variable__pf, /*out*/ bpfv__CallFunc_Array_Get_Item__pf);
				bpfv__CallFunc_GetComponentByClass_ReturnValue__pf = CastChecked<UUpgrade_C__pf77128533>(AActor::GetComponentByClass(bpfv__CallFunc_Array_Get_Item__pf), ECastCheckedType::NullAllowed);
				if(::IsValid(bpfv__CallFunc_GetComponentByClass_ReturnValue__pf))
				{
					bpfv__CallFunc_GetComponentByClass_ReturnValue__pf->bpv__upgraded__pf = 1;
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 9:
			{
				int32  __Local__6 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpp__Upgrade__pf)) ? (bpp__Upgrade__pf->bpv__upgraded__pf) : (__Local__6)), 0);
				...
				int32  __Local__7 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpp__Upgrade__pf)) ? (bpp__Upgrade__pf->bpv__upgraded__pf) : (__Local__7)), 1);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
					break;
				...
				int32  __Local__8 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpp__Upgrade__pf)) ? (bpp__Upgrade__pf->bpv__upgraded__pf) : (__Local__8)), 2);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 15;
					break;
		...
		case 10:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("Unknown Error.")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
			}
		case 11:
			{
		...
		case 12:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("Already Upgraded.")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
				__CurrentState = 11;
				break;
			}
		case 13:
		...
		case 15:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("Need Previous Upgrade.")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
				__CurrentState = 11;
				break;
			}
		default:
...
void Aupgrade_Manager_C__pf3789721252::bpf__InitxUpgrades__pfT(UClass* bpp__upgrade__pf)
{
	...
	do
	{
		...
		case 1:
			{
				bpfv__CallFunc_GetComponentByClass_ReturnValue__pf = CastChecked<UUpgrade_C__pf77128533>(AActor::GetComponentByClass(bpp__upgrade__pf), ECastCheckedType::NullAllowed);
				bpfv__CallFunc_IsValid_ReturnValue_1__pf = UKismetSystemLibrary::IsValid(bpfv__CallFunc_GetComponentByClass_ReturnValue__pf);
		...
		case 2:
			{
				bpfv__CallFunc_GetClassDisplayName_ReturnValue__pf = UKismetSystemLibrary::GetClassDisplayName(bpp__upgrade__pf);
				UKismetSystemLibrary::PrintString(this, bpfv__CallFunc_GetClassDisplayName_ReturnValue__pf, true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
			}
		case 3:
			{
				__CurrentState = -1;
		...
		case 4:
			{
				bpfv__CallFunc_AddComponentByClass_ReturnValue__pf = CastChecked<UUpgrade_C__pf77128533>(AActor::AddComponentByClass(bpp__upgrade__pf, false, FTransform( FQuat(0.000000,0.000000,0.000000,1.000000), FVector(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000) ), false), ECastCheckedType::NullAllowed);
			}
		case 5:
			{
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(bpfv__CallFunc_AddComponentByClass_ReturnValue__pf);
		...
		case 8:
			{
				bpfv__CallFunc_GetComponentByClass_ReturnValue__pf = CastChecked<UUpgrade_C__pf77128533>(AActor::GetComponentByClass(bpp__upgrade__pf), ECastCheckedType::NullAllowed);
				TArray<UClass*>  __Local__9 = {};
				bpfv__CallFunc_Array_Length_ReturnValue__pf = FCustomThunkTemplates::Array_Length(((::IsValid(bpfv__CallFunc_GetComponentByClass_ReturnValue__pf)) ? (bpfv__CallFunc_GetComponentByClass_ReturnValue__pf->bpv__Next_Upgrades__pf) : (__Local__9)));
				bpfv__CallFunc_Less_IntInt_ReturnValue__pf = UKismetMathLibrary::Less_IntInt(bpfv_____int_Loop_Counter_Variable__pf, bpfv__CallFunc_Array_Length_ReturnValue__pf);
				if (!bpfv__CallFunc_Less_IntInt_ReturnValue__pf)
				{
					__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
		...
		case 11:
			{
				bpfv__CallFunc_GetComponentByClass_ReturnValue__pf = CastChecked<UUpgrade_C__pf77128533>(AActor::GetComponentByClass(bpp__upgrade__pf), ECastCheckedType::NullAllowed);
				TArray<UClass*>  __Local__10 = {};
				FCustomThunkTemplates::Array_Get(((::IsValid(bpfv__CallFunc_GetComponentByClass_ReturnValue__pf)) ? (bpfv__CallFunc_GetComponentByClass_ReturnValue__pf->bpv__Next_Upgrades__pf) : (__Local__10)), bpfv_____int_Array_Index_Variable__pf, /*out*/ bpfv__CallFunc_Array_Get_Item__pf);
				bpf__InitxUpgrades__pfT(bpfv__CallFunc_Array_Get_Item__pf);
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 12:
...
PRAGMA_DISABLE_OPTIMIZATION
void Aupgrade_Manager_C__pf3789721252::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void Aupgrade_Manager_C__pf3789721252::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{125, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/blueprints/OnCollections/Upgrades/Base_Upgrade.Base_Upgrade_C 
		{112, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/blueprints/OnCollections/Upgrades/Upgrade.Upgrade_C 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__Aupgrade_Manager_C__pf3789721252
{
	FRegisterHelper__Aupgrade_Manager_C__pf3789721252()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/others/Observer/upgrade_Manager"), &Aupgrade_Manager_C__pf3789721252::__StaticDependenciesAssets);
	}
	static FRegisterHelper__Aupgrade_Manager_C__pf3789721252 Instance;
};
FRegisterHelper__Aupgrade_Manager_C__pf3789721252 FRegisterHelper__Aupgrade_Manager_C__pf3789721252::Instance;
