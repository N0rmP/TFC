...
USuit_Upgrade2_1_C__pf3462679379::USuit_Upgrade2_1_C__pf3462679379(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bCanEverAffectNavigation = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void USuit_Upgrade2_1_C__pf3462679379::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void USuit_Upgrade2_1_C__pf3462679379::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void USuit_Upgrade2_1_C__pf3462679379::bpf__On_Added__pf()
{
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	int32  __Local__0 = 0;
	bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(((::IsValid(bpv__suit__pf)) ? (bpv__suit__pf->bpv__plr_max_hp__pf) : (__Local__0)), 50);
...
PRAGMA_DISABLE_OPTIMIZATION
void USuit_Upgrade2_1_C__pf3462679379::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void USuit_Upgrade2_1_C__pf3462679379::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__USuit_Upgrade2_1_C__pf3462679379
{
	FRegisterHelper__USuit_Upgrade2_1_C__pf3462679379()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/OnCollections/Upgrades/Suit-upgrades/Suit_Upgrade2_1"), &USuit_Upgrade2_1_C__pf3462679379::__StaticDependenciesAssets);
	}
	static FRegisterHelper__USuit_Upgrade2_1_C__pf3462679379 Instance;
};
FRegisterHelper__USuit_Upgrade2_1_C__pf3462679379 FRegisterHelper__USuit_Upgrade2_1_C__pf3462679379::Instance;
