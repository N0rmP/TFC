...
URobot_Upgrade3_C__pf712717951::URobot_Upgrade3_C__pf712717951(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__prev_Upgrade__pf = URobot_Upgrade2_C__pf712717951::StaticClass();
	bpv__upgrade_Tier__pf = 3;
	bpv__upgraded__pf = 2;
	bpv__Name__pf = FString(TEXT("\ubd84\ucd9c\uae30 \uac1c\uc870"));
	bpv__Tool_Tip_Text__pf = FString(TEXT("\ub0c9\uac01 \ubc18\uacbd +50%"));
	bCanEverAffectNavigation = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void URobot_Upgrade3_C__pf712717951::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void URobot_Upgrade3_C__pf712717951::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void URobot_Upgrade3_C__pf712717951::bpf__On_Added__pf()
{
		...
		case 2:
			{
				...
				{
					bpfv__CallFunc_GetComponentByClass_ReturnValue__pf->SetAllMassScale(1.500000);
				}
				__CurrentState = -1;
				break;
			}
...
PRAGMA_DISABLE_OPTIMIZATION
void URobot_Upgrade3_C__pf712717951::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void URobot_Upgrade3_C__pf712717951::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__URobot_Upgrade3_C__pf712717951
{
	FRegisterHelper__URobot_Upgrade3_C__pf712717951()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/OnCollections/Upgrades/Robot-upgrades/Robot_Upgrade3"), &URobot_Upgrade3_C__pf712717951::__StaticDependenciesAssets);
	}
	static FRegisterHelper__URobot_Upgrade3_C__pf712717951 Instance;
};
FRegisterHelper__URobot_Upgrade3_C__pf712717951 FRegisterHelper__URobot_Upgrade3_C__pf712717951::Instance;
