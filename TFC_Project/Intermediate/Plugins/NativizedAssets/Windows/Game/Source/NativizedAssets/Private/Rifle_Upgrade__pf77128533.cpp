...
URifle_Upgrade_C__pf77128533::URifle_Upgrade_C__pf77128533(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__rifle__pf = nullptr;
	bpv__upgraded__pf = 1;
	bCanEverAffectNavigation = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void URifle_Upgrade_C__pf77128533::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void URifle_Upgrade_C__pf77128533::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void URifle_Upgrade_C__pf77128533::bpf__ExecuteUbergraph_Rifle_Upgrade__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	return; // KCST_GotoReturn
}
void URifle_Upgrade_C__pf77128533::bpf__ReceiveActorBeginOverlap_1__pf(AActor* bpp__OtherActor__pf)
{
	b2l__K2Node_Event_OtherActor__pf = bpp__OtherActor__pf;
	bpf__ExecuteUbergraph_Rifle_Upgrade__pf_0(1);
}
void URifle_Upgrade_C__pf77128533::bpf__On_Added__pf()
{
}
void URifle_Upgrade_C__pf77128533::bpf__On_Attack__pf()
{
	Super::bpf__On_Attack__pf();
}
void URifle_Upgrade_C__pf77128533::bpf__Set_Owner__pf(Arifle_C__pf3559600238* bpp__rifle__pf)
{
	bpv__rifle__pf = bpp__rifle__pf;
}
PRAGMA_DISABLE_OPTIMIZATION
void URifle_Upgrade_C__pf77128533::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void URifle_Upgrade_C__pf77128533::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{131, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/blueprints/OnCollections/Upgrades/Upgrade.Upgrade_C 
		...
		{114, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/blueprints/OnCollections/OnCollection.OnCollection_C 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__URifle_Upgrade_C__pf77128533
{
	FRegisterHelper__URifle_Upgrade_C__pf77128533()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/OnCollections/Upgrades/Rifle_Upgrade"), &URifle_Upgrade_C__pf77128533::__StaticDependenciesAssets);
	}
	static FRegisterHelper__URifle_Upgrade_C__pf77128533 Instance;
};
FRegisterHelper__URifle_Upgrade_C__pf77128533 FRegisterHelper__URifle_Upgrade_C__pf77128533::Instance;
