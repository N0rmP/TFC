...
URobot_Upgrade2_C__pf712717951::URobot_Upgrade2_C__pf712717951(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__Next_Upgrades__pf = TArray<UClass*> ();
	bpv__Next_Upgrades__pf.Reserve(1);
	bpv__Next_Upgrades__pf.Add(URobot_Upgrade3_C__pf712717951::StaticClass());
	bpv__prev_Upgrade__pf = URobot_Upgrade1_C__pf712717951::StaticClass();
	bpv__upgrade_Tier__pf = 2;
	bpv__upgraded__pf = 2;
	bpv__Name__pf = FString(TEXT("\ub0c9\uac01\uc218 \ubd84\ucd9c\uae30 \uc218\ub9ac"));
	bpv__Tool_Tip_Text__pf = FString(TEXT("\ub0c9\uac01 \ud6a8\uacfc +40%"));
	bCanEverAffectNavigation = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void URobot_Upgrade2_C__pf712717951::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void URobot_Upgrade2_C__pf712717951::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void URobot_Upgrade2_C__pf712717951::bpf__On_Added__pf()
{
	if(::IsValid(bpv__Robot__pf))
	{
		bpv__Robot__pf->bpv__advancedSlow__pf = true;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void URobot_Upgrade2_C__pf712717951::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void URobot_Upgrade2_C__pf712717951::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__URobot_Upgrade2_C__pf712717951
{
	FRegisterHelper__URobot_Upgrade2_C__pf712717951()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/OnCollections/Upgrades/Robot-upgrades/Robot_Upgrade2"), &URobot_Upgrade2_C__pf712717951::__StaticDependenciesAssets);
	}
	static FRegisterHelper__URobot_Upgrade2_C__pf712717951 Instance;
};
FRegisterHelper__URobot_Upgrade2_C__pf712717951 FRegisterHelper__URobot_Upgrade2_C__pf712717951::Instance;
