...
public:
	GENERATED_BODY()
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="디폴트", OverrideNativeName="Right"))
	UStaticMeshComponent* bpv__Right__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="디폴트", OverrideNativeName="Forward"))
	UStaticMeshComponent* bpv__Forward__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="디폴트", OverrideNativeName="Up"))
	UStaticMeshComponent* bpv__Up__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="디폴트", OverrideNativeName="ValidRadiusVisualizer"))
	USphereComponent* bpv__ValidRadiusVisualizer__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="디폴트", OverrideNativeName="AxisRoot"))
	USceneComponent* bpv__AxisRoot__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="디폴트", OverrideNativeName="VisualizerRoot"))
	USceneComponent* bpv__VisualizerRoot__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="디폴트", OverrideNativeName="TypeValue"))
	UTextRenderComponent* bpv__TypeValue__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="디폴트", OverrideNativeName="TransErrValue"))
	UTextRenderComponent* bpv__TransErrValue__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="디폴트", OverrideNativeName="RotErrValue"))
	UTextRenderComponent* bpv__RotErrValue__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="디폴트", OverrideNativeName="ConfidenceValue"))
	UTextRenderComponent* bpv__ConfidenceValue__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="디폴트", OverrideNativeName="TransErrLabel"))
	UTextRenderComponent* bpv__TransErrLabel__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="디폴트", OverrideNativeName="RotErrLabel"))
	UTextRenderComponent* bpv__RotErrLabel__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="디폴트", OverrideNativeName="ConfidenceLabel"))
	UTextRenderComponent* bpv__ConfidenceLabel__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="디폴트", OverrideNativeName="PinIDValue"))
	UTextRenderComponent* bpv__PinIDValue__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="디폴트", OverrideNativeName="InfoRoot"))
	USceneComponent* bpv__InfoRoot__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="디폴트", OverrideNativeName="Root"))
