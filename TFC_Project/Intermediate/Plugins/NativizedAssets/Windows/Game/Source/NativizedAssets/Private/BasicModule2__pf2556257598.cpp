...
UBasicModule2_C__pf2556257598::UBasicModule2_C__pf2556257598(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__Name__pf = FString(TEXT("\uacf5\uaca9 \ubcf4\uc870 \ubaa8\ub4c82"));
	bpv__Tool_Tip_Text__pf = FString(TEXT("\ub2e4\ub978 \uae30\ubcf8 \ud3ec\ud0d1\ub2f9 \uacf5\uaca9 \uc18d\ub3c4 +15%"));
	bCanEverAffectNavigation = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void UBasicModule2_C__pf2556257598::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UBasicModule2_C__pf2556257598::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void UBasicModule2_C__pf2556257598::bpf__ExecuteUbergraph_BasicModule2__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	return; // KCST_GotoReturn
}
void UBasicModule2_C__pf2556257598::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BasicModule2__pf_0(1);
}
void UBasicModule2_C__pf2556257598::bpf__On_Added__pf()
{
}
PRAGMA_DISABLE_OPTIMIZATION
void UBasicModule2_C__pf2556257598::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UBasicModule2_C__pf2556257598::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UBasicModule2_C__pf2556257598
{
	FRegisterHelper__UBasicModule2_C__pf2556257598()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/OnCollections/Modules/BasicModule2"), &UBasicModule2_C__pf2556257598::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UBasicModule2_C__pf2556257598 Instance;
};
FRegisterHelper__UBasicModule2_C__pf2556257598 FRegisterHelper__UBasicModule2_C__pf2556257598::Instance;
