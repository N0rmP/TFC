...
USuit_Upgrade1_C__pf3462679379::USuit_Upgrade1_C__pf3462679379(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__suit_0__pf = nullptr;
	bpv__Next_Upgrades__pf = TArray<UClass*> ();
	bpv__Next_Upgrades__pf.Reserve(1);
	bpv__Next_Upgrades__pf.Add(USuit_Upgrade2_C__pf3462679379::StaticClass());
	bpv__prev_Upgrade__pf = UBase_Upgrade_C__pf77128533::StaticClass();
	bpv__upgrade_Tier__pf = 1;
	bpv__Name__pf = FString(TEXT("\ubc29\uc5b4\ub9c9 \ucda9\uc804 \uac15\ud654"));
	bpv__Tool_Tip_Text__pf = FString(TEXT("\uccb4\ub825 \uc7ac\uc0dd \uc18d\ub3c4 +4"));
	bCanEverAffectNavigation = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void USuit_Upgrade1_C__pf3462679379::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void USuit_Upgrade1_C__pf3462679379::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void USuit_Upgrade1_C__pf3462679379::bpf__ExecuteUbergraph_Suit_Upgrade1__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	return; // KCST_GotoReturn
}
void USuit_Upgrade1_C__pf3462679379::bpf__ReceiveActorBeginOverlap_1__pf(AActor* bpp__OtherActor__pf)
{
	b3l__K2Node_Event_OtherActor__pf = bpp__OtherActor__pf;
	bpf__ExecuteUbergraph_Suit_Upgrade1__pf_0(1);
}
void USuit_Upgrade1_C__pf3462679379::bpf__On_Added__pf()
{
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	int32  __Local__0 = 0;
	bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(((::IsValid(bpv__suit__pf)) ? (bpv__suit__pf->bpv__hp_gen_amount__pf) : (__Local__0)), 4);
	if(::IsValid(bpv__suit__pf))
	{
		bpv__suit__pf->bpv__hp_gen_amount__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
	}
}
void USuit_Upgrade1_C__pf3462679379::bpf__On_Attacked__pf()
{
	Super::bpf__On_Attacked__pf();
}
PRAGMA_DISABLE_OPTIMIZATION
void USuit_Upgrade1_C__pf3462679379::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void USuit_Upgrade1_C__pf3462679379::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{132, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/blueprints/OnCollections/Upgrades/Suit_Upgrade.Suit_Upgrade_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__USuit_Upgrade1_C__pf3462679379
{
	FRegisterHelper__USuit_Upgrade1_C__pf3462679379()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/OnCollections/Upgrades/Suit-upgrades/Suit_Upgrade1"), &USuit_Upgrade1_C__pf3462679379::__StaticDependenciesAssets);
	}
	static FRegisterHelper__USuit_Upgrade1_C__pf3462679379 Instance;
};
FRegisterHelper__USuit_Upgrade1_C__pf3462679379 FRegisterHelper__USuit_Upgrade1_C__pf3462679379::Instance;
