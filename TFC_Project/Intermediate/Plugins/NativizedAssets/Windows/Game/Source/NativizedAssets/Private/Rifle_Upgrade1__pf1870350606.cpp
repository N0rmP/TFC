...
URifle_Upgrade1_C__pf1870350606::URifle_Upgrade1_C__pf1870350606(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__rifle_0__pf = nullptr;
	bpv__Next_Upgrades__pf = TArray<UClass*> ();
	bpv__Next_Upgrades__pf.Reserve(1);
	bpv__Next_Upgrades__pf.Add(URifle_Upgrade2_C__pf1870350606::StaticClass());
	bpv__prev_Upgrade__pf = UBase_Upgrade_C__pf77128533::StaticClass();
	bpv__upgrade_Tier__pf = 1;
	bpv__Name__pf = FString(TEXT("D-5 \ucca0\uac11\ud0c4"));
	bpv__Tool_Tip_Text__pf = FString(TEXT("\uacf5\uaca9\ub825 +5"));
	bCanEverAffectNavigation = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void URifle_Upgrade1_C__pf1870350606::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void URifle_Upgrade1_C__pf1870350606::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void URifle_Upgrade1_C__pf1870350606::bpf__ExecuteUbergraph_Rifle_Upgrade1__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	return; // KCST_GotoReturn
}
void URifle_Upgrade1_C__pf1870350606::bpf__ReceiveActorBeginOverlap_1__pf(AActor* bpp__OtherActor__pf)
{
	b3l__K2Node_Event_OtherActor__pf = bpp__OtherActor__pf;
	bpf__ExecuteUbergraph_Rifle_Upgrade1__pf_0(1);
}
void URifle_Upgrade1_C__pf1870350606::bpf__On_Added__pf()
{
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	int32  __Local__0 = 0;
	bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(((::IsValid(bpv__rifle__pf)) ? (bpv__rifle__pf->bpv__damage_per_bullet__pf) : (__Local__0)), 5);
	if(::IsValid(bpv__rifle__pf))
	{
		bpv__rifle__pf->bpv__damage_per_bullet__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
	}
}
void URifle_Upgrade1_C__pf1870350606::bpf__On_Attack__pf()
{
	Super::bpf__On_Attack__pf();
}
PRAGMA_DISABLE_OPTIMIZATION
void URifle_Upgrade1_C__pf1870350606::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void URifle_Upgrade1_C__pf1870350606::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{144, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/blueprints/OnCollections/Upgrades/Rifle_Upgrade.Rifle_Upgrade_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__URifle_Upgrade1_C__pf1870350606
{
	FRegisterHelper__URifle_Upgrade1_C__pf1870350606()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/OnCollections/Upgrades/Rifle-upgrades/Rifle_Upgrade1"), &URifle_Upgrade1_C__pf1870350606::__StaticDependenciesAssets);
	}
	static FRegisterHelper__URifle_Upgrade1_C__pf1870350606 Instance;
};
FRegisterHelper__URifle_Upgrade1_C__pf1870350606 FRegisterHelper__URifle_Upgrade1_C__pf1870350606::Instance;
