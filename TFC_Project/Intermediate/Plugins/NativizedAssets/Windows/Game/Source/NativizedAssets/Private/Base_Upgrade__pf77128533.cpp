...
UBase_Upgrade_C__pf77128533::UBase_Upgrade_C__pf77128533(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bCanEverAffectNavigation = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void UBase_Upgrade_C__pf77128533::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UBase_Upgrade_C__pf77128533::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void UBase_Upgrade_C__pf77128533::bpf__ExecuteUbergraph_Base_Upgrade__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 2);
	// optimized KCST_UnconditionalGoto
	b2l__K2Node_MakeArray_Array__pf.SetNum(3, true);
	b2l__K2Node_MakeArray_Array__pf[0] = URifle_Upgrade1_C__pf1870350606::StaticClass();
	b2l__K2Node_MakeArray_Array__pf[1] = USuit_Upgrade1_C__pf3462679379::StaticClass();
	b2l__K2Node_MakeArray_Array__pf[2] = URobot_Upgrade1_C__pf712717951::StaticClass();
	bpv__Next_Upgrades__pf = b2l__K2Node_MakeArray_Array__pf;
	return; // KCST_GotoReturn
}
void UBase_Upgrade_C__pf77128533::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_Base_Upgrade__pf_0(2);
}
PRAGMA_DISABLE_OPTIMIZATION
void UBase_Upgrade_C__pf77128533::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UBase_Upgrade_C__pf77128533::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UBase_Upgrade_C__pf77128533
{
	FRegisterHelper__UBase_Upgrade_C__pf77128533()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/OnCollections/Upgrades/Base_Upgrade"), &UBase_Upgrade_C__pf77128533::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UBase_Upgrade_C__pf77128533 Instance;
};
FRegisterHelper__UBase_Upgrade_C__pf77128533 FRegisterHelper__UBase_Upgrade_C__pf77128533::Instance;
