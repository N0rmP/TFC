...
Atest_C__pf4098986762::Atest_C__pf4098986762(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	bpv__Cube__pf->AttachToComponent(__Local__0, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__12 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Cube__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__12 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(Atest_C__pf4098986762::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Cube__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Cube__pf->OverrideMaterials.Reserve(1);
	bpv__Cube__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(Atest_C__pf4098986762::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	...
	(((FBoolProperty*)__Local__13)->SetPropertyValue_InContainer((bpv__Cube__pf), true, 0));
...
void Atest_C__pf4098986762::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void Atest_C__pf4098986762::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void Atest_C__pf4098986762::bpf__ExecuteUbergraph_test__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	{
		bpv__damagable__pf->bpf__get_cur_hp__pf(/*out*/ b1l__CallFunc_get_cur_hp_cur_hp_res__pf);
	}
	bpfv__CallFunc_Conv_IntToFloat_ReturnValue__pf = UKismetMathLibrary::Conv_IntToFloat(b1l__CallFunc_get_cur_hp_cur_hp_res__pf);
	bpfv__CallFunc_Conv_FloatToVector_ReturnValue__pf = UKismetMathLibrary::Conv_FloatToVector(bpfv__CallFunc_Conv_IntToFloat_ReturnValue__pf);
	if(::IsValid(bpv__Cube__pf))
	{
		bpv__Cube__pf->USceneComponent::SetRelativeScale3D(bpfv__CallFunc_Conv_FloatToVector_ReturnValue__pf);
	}
	return; // KCST_GotoReturn
}
void Atest_C__pf4098986762::bpf__ExecuteUbergraph_test__pf_1(int32 bpp__EntryPoint__pf)
{
...
void Atest_C__pf4098986762::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_test__pf_1(4);
}
void Atest_C__pf4098986762::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b1l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_test__pf_0(1);
}
void Atest_C__pf4098986762::bpf__UserConstructionScript__pf()
{
	Super::bpf__UserConstructionScript__pf();
	SetOwner(this);
}
PRAGMA_DISABLE_OPTIMIZATION
void Atest_C__pf4098986762::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void Atest_C__pf4098986762::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__Atest_C__pf4098986762
{
	FRegisterHelper__Atest_C__pf4098986762()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/monster/test/test"), &Atest_C__pf4098986762::__StaticDependenciesAssets);
	}
	static FRegisterHelper__Atest_C__pf4098986762 Instance;
};
FRegisterHelper__Atest_C__pf4098986762 FRegisterHelper__Atest_C__pf4098986762::Instance;
